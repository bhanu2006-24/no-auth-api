...
st.set_page_config(page_title="Hong Kong GeoData Store", page_icon="🌐")

st.title("🌐 Hong Kong GeoData Store")
st.markdown("""
API for accessing geo-data of Hong Kong

**URL:** [https://geodata.gov.hk/gs/](https://geodata.gov.hk/gs/)
""")
...
url = st.text_input("API Endpoint", "https://geodata.gov.hk/gs/")
