...
st.set_page_config(page_title="SHARE", page_icon="🌐")

st.title("🌐 SHARE")
st.markdown("""
A free, open, dataset about research and scholarly activities

**URL:** [https://share.osf.io/api/v2/](https://share.osf.io/api/v2/)
""")
...
url = st.text_input("API Endpoint", "https://share.osf.io/api/v2/")
