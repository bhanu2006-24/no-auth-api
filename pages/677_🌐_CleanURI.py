...
st.set_page_config(page_title="CleanURI", page_icon="🌐")

st.title("🌐 CleanURI")
st.markdown("""
URL shortener service

**URL:** [https://cleanuri.com/docs](https://cleanuri.com/docs)
""")
...
url = st.text_input("API Endpoint", "https://cleanuri.com/docs")
