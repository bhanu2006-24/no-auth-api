...
st.set_page_config(page_title="Open Topo Data", page_icon="🌐")

st.title("🌐 Open Topo Data")
st.markdown("""
Elevation and ocean depth for a latitude and longitude

**URL:** [https://www.opentopodata.org](https://www.opentopodata.org)
""")
...
url = st.text_input("API Endpoint", "https://www.opentopodata.org")
