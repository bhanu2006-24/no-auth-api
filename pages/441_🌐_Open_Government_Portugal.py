...
st.set_page_config(page_title="Open Government, Portugal", page_icon="🌐")

st.title("🌐 Open Government, Portugal")
st.markdown("""
Portugal Government Open Data

**URL:** [https://dados.gov.pt/en/docapi/](https://dados.gov.pt/en/docapi/)
""")
...
url = st.text_input("API Endpoint", "https://dados.gov.pt/en/docapi/")
