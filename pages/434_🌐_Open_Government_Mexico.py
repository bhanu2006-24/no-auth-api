...
st.set_page_config(page_title="Open Government, Mexico", page_icon="🌐")

st.title("🌐 Open Government, Mexico")
st.markdown("""
Mexican Statistical Government Open Data

**URL:** [https://www.inegi.org.mx/datos/](https://www.inegi.org.mx/datos/)
""")
...
url = st.text_input("API Endpoint", "https://www.inegi.org.mx/datos/")
