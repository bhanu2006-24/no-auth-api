...
st.set_page_config(page_title="Open Government, Germany", page_icon="🌐")

st.title("🌐 Open Government, Germany")
st.markdown("""
Germany Government Open Data

**URL:** [https://www.govdata.de/daten/-/details/govdata-metadatenkatalog](https://www.govdata.de/daten/-/details/govdata-metadatenkatalog)
""")
...
url = st.text_input("API Endpoint", "https://www.govdata.de/daten/-/details/govdata-metadatenkatalog")
