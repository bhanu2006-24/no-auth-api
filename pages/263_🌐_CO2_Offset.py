...
st.set_page_config(page_title="CO2 Offset", page_icon="🌐")

st.title("🌐 CO2 Offset")
st.markdown("""
API calculates and validates the carbon footprint

**URL:** [https://co2offset.io/api.html](https://co2offset.io/api.html)
""")
...
url = st.text_input("API Endpoint", "https://co2offset.io/api.html")
