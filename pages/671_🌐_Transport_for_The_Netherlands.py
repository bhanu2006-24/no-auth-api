...
st.set_page_config(page_title="Transport for The Netherlands", page_icon="🌐")

st.title("🌐 Transport for The Netherlands")
st.markdown("""
OVAPI, country-wide public transport

**URL:** [https://github.com/skywave/KV78Turbo-OVAPI/wiki](https://github.com/skywave/KV78Turbo-OVAPI/wiki)
""")
...
url = st.text_input("API Endpoint", "https://github.com/skywave/KV78Turbo-OVAPI/wiki")
