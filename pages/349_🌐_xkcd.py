...
st.set_page_config(page_title="xkcd", page_icon="🌐")

st.title("🌐 xkcd")
st.markdown("""
Retrieve xkcd comics as JSON

**URL:** [https://xkcd.com/json.html](https://xkcd.com/json.html)
""")
...
url = st.text_input("API Endpoint", "https://xkcd.com/json.html")
