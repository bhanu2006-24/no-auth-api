...
st.set_page_config(page_title="AviationWeather", page_icon="🌐")

st.title("🌐 AviationWeather")
st.markdown("""
NOAA aviation weather forecasts and observations

**URL:** [https://www.aviationweather.gov/dataserver](https://www.aviationweather.gov/dataserver)
""")
...
url = st.text_input("API Endpoint", "https://www.aviationweather.gov/dataserver")
