...
st.set_page_config(page_title="Animal Crossing: New Horizons", page_icon="🌐")

st.title("🌐 Animal Crossing: New Horizons")
st.markdown("""
API for critters, fossils, art, music, furniture and villagers

**URL:** [http://acnhapi.com/](http://acnhapi.com/)
""")
...
url = st.text_input("API Endpoint", "http://acnhapi.com/")
