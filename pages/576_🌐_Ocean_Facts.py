...
st.set_page_config(page_title="Ocean Facts", page_icon="🌐")

st.title("🌐 Ocean Facts")
st.markdown("""
Facts pertaining to the physical science of Oceanography

**URL:** [https://oceanfacts.herokuapp.com/](https://oceanfacts.herokuapp.com/)
""")
...
url = st.text_input("API Endpoint", "https://oceanfacts.herokuapp.com/")
