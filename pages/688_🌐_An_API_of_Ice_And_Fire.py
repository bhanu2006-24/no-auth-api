...
st.set_page_config(page_title="An API of Ice And Fire", page_icon="🌐")

st.title("🌐 An API of Ice And Fire")
st.markdown("""
Game Of Thrones API

**URL:** [https://anapioficeandfire.com/](https://anapioficeandfire.com/)
""")
...
url = st.text_input("API Endpoint", "https://anapioficeandfire.com/")
