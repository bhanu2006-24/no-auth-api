...
st.set_page_config(page_title="Rustybeer", page_icon="🌐")

st.title("🌐 Rustybeer")
st.markdown("""
Beer brewing tools

**URL:** [https://rustybeer.herokuapp.com/](https://rustybeer.herokuapp.com/)
""")
...
url = st.text_input("API Endpoint", "https://rustybeer.herokuapp.com/")
