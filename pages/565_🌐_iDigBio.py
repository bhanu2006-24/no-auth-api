...
st.set_page_config(page_title="iDigBio", page_icon="🌐")

st.title("🌐 iDigBio")
st.markdown("""
Access millions of museum specimens from organizations around the world

**URL:** [https://github.com/idigbio/idigbio-search-api/wiki](https://github.com/idigbio/idigbio-search-api/wiki)
""")
...
url = st.text_input("API Endpoint", "https://github.com/idigbio/idigbio-search-api/wiki")
