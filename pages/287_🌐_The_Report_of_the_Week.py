...
st.set_page_config(page_title="The Report of the Week", page_icon="🌐")

st.title("🌐 The Report of the Week")
st.markdown("""
Food & Drink Reviews

**URL:** [https://github.com/andyklimczak/TheReportOfTheWeek-API](https://github.com/andyklimczak/TheReportOfTheWeek-API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/andyklimczak/TheReportOfTheWeek-API")
