...
st.set_page_config(page_title="FFXIV Collect", page_icon="🌐")

st.title("🌐 FFXIV Collect")
st.markdown("""
Final Fantasy XIV data on collectables

**URL:** [https://ffxivcollect.com/](https://ffxivcollect.com/)
""")
...
url = st.text_input("API Endpoint", "https://ffxivcollect.com/")
