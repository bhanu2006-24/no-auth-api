...
st.set_page_config(page_title="Graphs for Coronavirus", page_icon="🌐")

st.title("🌐 Graphs for Coronavirus")
st.markdown("""
Each Country separately and Worldwide Graphs for Coronavirus. Daily updates

**URL:** [https://corona.dnsforfamily.com/api.txt](https://corona.dnsforfamily.com/api.txt)
""")
...
url = st.text_input("API Endpoint", "https://corona.dnsforfamily.com/api.txt")
