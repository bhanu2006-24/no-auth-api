...
st.set_page_config(page_title="Istanbul (İBB) Open Data", page_icon="🌐")

st.title("🌐 Istanbul (İBB) Open Data")
st.markdown("""
Data sets from the İstanbul Metropolitan Municipality (İBB)

**URL:** [https://data.ibb.gov.tr](https://data.ibb.gov.tr)
""")
...
url = st.text_input("API Endpoint", "https://data.ibb.gov.tr")
