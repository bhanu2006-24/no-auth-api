...
st.set_page_config(page_title="OpenVisionAPI", page_icon="🌐")

st.title("🌐 OpenVisionAPI")
st.markdown("""
Open source computer vision API based on open source models

**URL:** [https://openvisionapi.com](https://openvisionapi.com)
""")
...
url = st.text_input("API Endpoint", "https://openvisionapi.com")
