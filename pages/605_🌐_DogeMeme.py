...
st.set_page_config(page_title="Doge-Meme", page_icon="🌐")

st.title("🌐 Doge-Meme")
st.markdown("""
Top meme posts from r/dogecoin which include 'Meme' flair

**URL:** [https://api.doge-meme.lol/docs](https://api.doge-meme.lol/docs)
""")
...
url = st.text_input("API Endpoint", "https://api.doge-meme.lol/docs")
