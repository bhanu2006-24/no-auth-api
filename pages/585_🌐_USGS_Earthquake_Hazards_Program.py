...
st.set_page_config(page_title="USGS Earthquake Hazards Program", page_icon="🌐")

st.title("🌐 USGS Earthquake Hazards Program")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://earthquake.usgs.gov/fdsnws/event/1/")
