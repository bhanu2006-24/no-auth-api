...
st.set_page_config(page_title="Callook.info", page_icon="🌐")

st.title("🌐 Callook.info")
st.markdown("""
United States ham radio callsigns

**URL:** [https://callook.info](https://callook.info)
""")
...
url = st.text_input("API Endpoint", "https://callook.info")
