...
st.set_page_config(page_title="Bank Negara Malaysia Open Data", page_icon="🌐")

st.title("🌐 Bank Negara Malaysia Open Data")
st.markdown("""
Malaysia Central Bank Open Data

**URL:** [https://apikijangportal.bnm.gov.my/](https://apikijangportal.bnm.gov.my/)
""")
...
url = st.text_input("API Endpoint", "https://apikijangportal.bnm.gov.my/")
