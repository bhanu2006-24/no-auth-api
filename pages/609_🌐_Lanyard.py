...
st.set_page_config(page_title="Lanyard", page_icon="🌐")

st.title("🌐 Lanyard")
st.markdown("""
Retrieve your presence on Discord through an HTTP REST API or WebSocket

**URL:** [https://github.com/Phineas/lanyard](https://github.com/Phineas/lanyard)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Phineas/lanyard")
