...
st.set_page_config(page_title="Dehash.lt", page_icon="🌐")

st.title("🌐 Dehash.lt")
st.markdown("""
Hash decryption MD5, SHA1, SHA3, SHA256, SHA384, SHA512

**URL:** [https://github.com/Dehash-lt/api](https://github.com/Dehash-lt/api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Dehash-lt/api")
