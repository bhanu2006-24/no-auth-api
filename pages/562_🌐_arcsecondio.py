...
st.set_page_config(page_title="arcsecond.io", page_icon="🌐")

st.title("🌐 arcsecond.io")
st.markdown("""
Multiple astronomy data sources

**URL:** [https://api.arcsecond.io/](https://api.arcsecond.io/)
""")
...
url = st.text_input("API Endpoint", "https://api.arcsecond.io/")
