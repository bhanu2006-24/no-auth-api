...
st.set_page_config(page_title="Currency-api", page_icon="🌐")

st.title("🌐 Currency-api")
st.markdown("""
Free Currency Exchange Rates API with 150+ Currencies & No Rate Limits

**URL:** [https://github.com/fawazahmed0/currency-api#readme](https://github.com/fawazahmed0/currency-api#readme)
""")
...
url = st.text_input("API Endpoint", "https://github.com/fawazahmed0/currency-api#readme")
