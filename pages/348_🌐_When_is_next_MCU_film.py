...
st.set_page_config(page_title="When is next MCU film", page_icon="🌐")

st.title("🌐 When is next MCU film")
st.markdown("""
Upcoming MCU film information

**URL:** [https://github.com/DiljotSG/MCU-Countdown/blob/develop/docs/API.md](https://github.com/DiljotSG/MCU-Countdown/blob/develop/docs/API.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/DiljotSG/MCU-Countdown/blob/develop/docs/API.md")
