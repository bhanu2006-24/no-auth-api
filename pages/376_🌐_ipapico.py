...
st.set_page_config(page_title="ipapi.co", page_icon="🌐")

st.title("🌐 ipapi.co")
st.markdown("""
Find IP address location information

**URL:** [https://ipapi.co/api/#introduction](https://ipapi.co/api/#introduction)
""")
...
url = st.text_input("API Endpoint", "https://ipapi.co/api/#introduction")
