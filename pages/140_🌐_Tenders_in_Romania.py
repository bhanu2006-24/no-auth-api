...
st.set_page_config(page_title="Tenders in Romania", page_icon="🌐")

st.title("🌐 Tenders in Romania")
st.markdown("""
Get data for procurements in Romania in JSON format

**URL:** [https://tenders.guru/ro/api](https://tenders.guru/ro/api)
""")
...
url = st.text_input("API Endpoint", "https://tenders.guru/ro/api")
