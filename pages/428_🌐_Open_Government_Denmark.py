...
st.set_page_config(page_title="Open Government, Denmark", page_icon="🌐")

st.title("🌐 Open Government, Denmark")
st.markdown("""
Denmark Government Open Data

**URL:** [https://www.opendata.dk/](https://www.opendata.dk/)
""")
...
url = st.text_input("API Endpoint", "https://www.opendata.dk/")
