...
st.set_page_config(page_title="Times Adder", page_icon="🌐")

st.title("🌐 Times Adder")
st.markdown("""
With this API you can add each of the times introduced in the array sended

**URL:** [https://github.com/FranP-code/API-Times-Adder](https://github.com/FranP-code/API-Times-Adder)
""")
...
url = st.text_input("API Endpoint", "https://github.com/FranP-code/API-Times-Adder")
