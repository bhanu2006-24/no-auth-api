...
st.set_page_config(page_title="Mexico", page_icon="🌐")

st.title("🌐 Mexico")
st.markdown("""
Mexico RESTful zip codes API

**URL:** [https://github.com/IcaliaLabs/sepomex](https://github.com/IcaliaLabs/sepomex)
""")
...
url = st.text_input("API Endpoint", "https://github.com/IcaliaLabs/sepomex")
