...
st.set_page_config(page_title="Tenders in Spain", page_icon="🌐")

st.title("🌐 Tenders in Spain")
st.markdown("""
Get data for procurements in Spain in JSON format

**URL:** [https://tenders.guru/es/api](https://tenders.guru/es/api)
""")
...
url = st.text_input("API Endpoint", "https://tenders.guru/es/api")
