...
st.set_page_config(page_title="AviationAPI", page_icon="🌐")

st.title("🌐 AviationAPI")
st.markdown("""
FAA Aeronautical Charts and Publications, Airport Information, and Airport Weather

**URL:** [https://docs.aviationapi.com](https://docs.aviationapi.com)
""")
...
url = st.text_input("API Endpoint", "https://docs.aviationapi.com")
