...
st.set_page_config(page_title="Transport for Los Angeles, US", page_icon="🌐")

st.title("🌐 Transport for Los Angeles, US")
st.markdown("""
Data about positions of Metro vehicles in real time and travel their routes

**URL:** [https://developer.metro.net/api/](https://developer.metro.net/api/)
""")
...
url = st.text_input("API Endpoint", "https://developer.metro.net/api/")
