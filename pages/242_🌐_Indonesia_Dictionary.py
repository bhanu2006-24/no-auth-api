...
st.set_page_config(page_title="Indonesia Dictionary", page_icon="🌐")

st.title("🌐 Indonesia Dictionary")
st.markdown("""
Indonesia dictionary many words

**URL:** [https://new-kbbi-api.herokuapp.com/](https://new-kbbi-api.herokuapp.com/)
""")
...
url = st.text_input("API Endpoint", "https://new-kbbi-api.herokuapp.com/")
