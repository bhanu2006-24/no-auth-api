...
st.set_page_config(page_title="Traitify", page_icon="🌐")

st.title("🌐 Traitify")
st.markdown("""
Assess, collect and analyze Personality

**URL:** [https://app.traitify.com/developer](https://app.traitify.com/developer)
""")
...
url = st.text_input("API Endpoint", "https://app.traitify.com/developer")
