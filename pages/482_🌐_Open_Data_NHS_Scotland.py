...
st.set_page_config(page_title="Open Data NHS Scotland", page_icon="🌐")

st.title("🌐 Open Data NHS Scotland")
st.markdown("""
Medical reference data and statistics by Public Health Scotland

**URL:** [https://www.opendata.nhs.scot](https://www.opendata.nhs.scot)
""")
...
url = st.text_input("API Endpoint", "https://www.opendata.nhs.scot")
