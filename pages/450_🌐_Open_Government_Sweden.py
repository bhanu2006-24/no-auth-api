...
st.set_page_config(page_title="Open Government, Sweden", page_icon="🌐")

st.title("🌐 Open Government, Sweden")
st.markdown("""
Sweden Government Open Data

**URL:** [https://www.dataportal.se/en/dataservice/91_29789/api-for-the-statistical-database](https://www.dataportal.se/en/dataservice/91_29789/api-for-the-statistical-database)
""")
...
url = st.text_input("API Endpoint", "https://www.dataportal.se/en/dataservice/91_29789/api-for-the-statistical-database")
