...
**URL:** [https://github.com/burhanuday/cors-proxy](https://github.com/burhanuday/cors-proxy)
""")
...
url = st.text_input("API Endpoint", "https://github.com/burhanuday/cors-proxy")
