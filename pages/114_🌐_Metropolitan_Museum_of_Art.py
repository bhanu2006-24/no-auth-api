...
st.set_page_config(page_title="Metropolitan Museum of Art", page_icon="🌐")

st.title("🌐 Metropolitan Museum of Art")
st.markdown("""
Met Museum of Art

**URL:** [https://metmuseum.github.io/](https://metmuseum.github.io/)
""")
...
url = st.text_input("API Endpoint", "https://metmuseum.github.io/")
