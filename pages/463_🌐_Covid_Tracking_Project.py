...
st.set_page_config(page_title="Covid Tracking Project", page_icon="🌐")

st.title("🌐 Covid Tracking Project")
st.markdown("""
Covid-19  data for the US

**URL:** [https://covidtracking.com/data/api/version-2](https://covidtracking.com/data/api/version-2)
""")
...
url = st.text_input("API Endpoint", "https://covidtracking.com/data/api/version-2")
