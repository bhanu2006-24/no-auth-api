...
st.set_page_config(page_title="Forismatic", page_icon="🌐")

st.title("🌐 Forismatic")
st.markdown("""
Inspirational Quotes

**URL:** [http://forismatic.com/en/api/](http://forismatic.com/en/api/)
""")
...
url = st.text_input("API Endpoint", "http://forismatic.com/en/api/")
