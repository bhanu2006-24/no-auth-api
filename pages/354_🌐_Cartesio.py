...
st.set_page_config(page_title="Cartes.io", page_icon="🌐")

st.title("🌐 Cartes.io")
st.markdown("""
Create maps and markers for anything

**URL:** [https://github.com/M-Media-Group/Cartes.io/wiki/API](https://github.com/M-Media-Group/Cartes.io/wiki/API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/M-Media-Group/Cartes.io/wiki/API")
