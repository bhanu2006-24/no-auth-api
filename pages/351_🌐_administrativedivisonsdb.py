...
st.set_page_config(page_title="administrative-divisons-db", page_icon="🌐")

st.title("🌐 administrative-divisons-db")
st.markdown("""
Get all administrative divisions of a country

**URL:** [https://github.com/kamikazechaser/administrative-divisions-db](https://github.com/kamikazechaser/administrative-divisions-db)
""")
...
url = st.text_input("API Endpoint", "https://github.com/kamikazechaser/administrative-divisions-db")
