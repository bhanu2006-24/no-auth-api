...
st.set_page_config(page_title="WakaTime", page_icon="🌐")

st.title("🌐 WakaTime")
st.markdown("""
Automated time tracking leaderboards for programmers

**URL:** [https://wakatime.com/developers](https://wakatime.com/developers)
""")
...
url = st.text_input("API Endpoint", "https://wakatime.com/developers")
