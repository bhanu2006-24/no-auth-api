...
st.set_page_config(page_title="Transport for Grenoble, France", page_icon="🌐")

st.title("🌐 Transport for Grenoble, France")
st.markdown("""
Grenoble public transport

**URL:** [https://www.mobilites-m.fr/pages/opendata/OpenDataApi.html](https://www.mobilites-m.fr/pages/opendata/OpenDataApi.html)
""")
...
url = st.text_input("API Endpoint", "https://www.mobilites-m.fr/pages/opendata/OpenDataApi.html")
