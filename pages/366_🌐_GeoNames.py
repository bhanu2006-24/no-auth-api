...
st.set_page_config(page_title="GeoNames", page_icon="🌐")

st.title("🌐 GeoNames")
st.markdown("""
Place names and other geographical data

**URL:** [http://www.geonames.org/export/web-services.html](http://www.geonames.org/export/web-services.html)
""")
...
url = st.text_input("API Endpoint", "http://www.geonames.org/export/web-services.html")
