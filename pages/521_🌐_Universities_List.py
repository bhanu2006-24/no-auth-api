...
st.set_page_config(page_title="Universities List", page_icon="🌐")

st.title("🌐 Universities List")
st.markdown("""
University names, countries and domains

**URL:** [https://github.com/Hipo/university-domains-list](https://github.com/Hipo/university-domains-list)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Hipo/university-domains-list")
