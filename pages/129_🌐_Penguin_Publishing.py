...
st.title("🌐 Penguin Publishing")
st.markdown("""
Books, book covers and related data

**URL:** [http://www.penguinrandomhouse.biz/webservices/rest/](http://www.penguinrandomhouse.biz/webservices/rest/)
""")
...
url = st.text_input("API Endpoint", "http://www.penguinrandomhouse.biz/webservices/rest/")
