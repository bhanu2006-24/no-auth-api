...
st.set_page_config(page_title="Open Government, Canada", page_icon="🌐")

st.title("🌐 Open Government, Canada")
st.markdown("""
Canadian Government Open Data

**URL:** [http://open.canada.ca/en](http://open.canada.ca/en)
""")
...
url = st.text_input("API Endpoint", "http://open.canada.ca/en")
