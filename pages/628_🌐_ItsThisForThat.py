...
st.set_page_config(page_title="ItsThisForThat", page_icon="🌐")

st.title("🌐 ItsThisForThat")
st.markdown("""
Generate Random startup ideas

**URL:** [https://itsthisforthat.com/api.php](https://itsthisforthat.com/api.php)
""")
...
url = st.text_input("API Endpoint", "https://itsthisforthat.com/api.php")
