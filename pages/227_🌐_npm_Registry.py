...
st.title("🌐 npm Registry")
st.markdown("""
Query information about your favorite Node.js libraries programatically

**URL:** [https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md](https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md")
