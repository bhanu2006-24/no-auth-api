...
st.set_page_config(page_title="Brazil Central Bank Open Data", page_icon="🌐")

st.title("🌐 Brazil Central Bank Open Data")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://dadosabertos.bcb.gov.br/")
