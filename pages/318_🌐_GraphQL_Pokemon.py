...
st.set_page_config(page_title="GraphQL Pokemon", page_icon="🌐")

st.title("🌐 GraphQL Pokemon")
st.markdown("""
GraphQL powered Pokemon API. Supports generations 1 through 8

**URL:** [https://github.com/favware/graphql-pokemon](https://github.com/favware/graphql-pokemon)
""")
...
url = st.text_input("API Endpoint", "https://github.com/favware/graphql-pokemon")
