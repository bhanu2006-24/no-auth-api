...
st.set_page_config(page_title="University of Oslo", page_icon="🌐")

st.title("🌐 University of Oslo")
st.markdown("""
Courses, lecture videos, detailed information for courses etc. for the University of Oslo (Norway)

**URL:** [https://data.uio.no/](https://data.uio.no/)
""")
...
url = st.text_input("API Endpoint", "https://data.uio.no/")
