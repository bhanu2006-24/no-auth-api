...
st.set_page_config(page_title="Open Government, Spain", page_icon="🌐")

st.title("🌐 Open Government, Spain")
st.markdown("""
Spain Government Open Data

**URL:** [https://datos.gob.es/en](https://datos.gob.es/en)
""")
...
url = st.text_input("API Endpoint", "https://datos.gob.es/en")
