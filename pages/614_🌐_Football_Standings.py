...
st.set_page_config(page_title="Football Standings", page_icon="🌐")

st.title("🌐 Football Standings")
st.markdown("""
Display football standings e.g epl, la liga, serie a etc. The data is based on espn site

**URL:** [https://github.com/azharimm/football-standings-api](https://github.com/azharimm/football-standings-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/azharimm/football-standings-api")
