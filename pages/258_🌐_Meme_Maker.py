...
st.set_page_config(page_title="Meme Maker", page_icon="🌐")

st.title("🌐 Meme Maker")
st.markdown("""
REST API for create your own meme

**URL:** [https://mememaker.github.io/API/](https://mememaker.github.io/API/)
""")
...
url = st.text_input("API Endpoint", "https://mememaker.github.io/API/")
