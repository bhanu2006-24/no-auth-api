...
st.set_page_config(page_title="IPGEO", page_icon="🌐")

st.title("🌐 IPGEO")
st.markdown("""
Unlimited free IP Address API with useful information

**URL:** [https://api.techniknews.net/ipgeo/](https://api.techniknews.net/ipgeo/)
""")
...
url = st.text_input("API Endpoint", "https://api.techniknews.net/ipgeo/")
