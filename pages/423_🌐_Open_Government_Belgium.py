...
st.set_page_config(page_title="Open Government, Belgium", page_icon="🌐")

st.title("🌐 Open Government, Belgium")
st.markdown("""
Belgium Government Open Data

**URL:** [https://data.gov.be/](https://data.gov.be/)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.be/")
