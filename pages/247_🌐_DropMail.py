...
st.set_page_config(page_title="DropMail", page_icon="🌐")

st.title("🌐 DropMail")
st.markdown("""
GraphQL API for creating and managing ephemeral e-mail inboxes

**URL:** [https://dropmail.me/api/#live-demo](https://dropmail.me/api/#live-demo)
""")
...
url = st.text_input("API Endpoint", "https://dropmail.me/api/#live-demo")
