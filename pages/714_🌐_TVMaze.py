...
st.set_page_config(page_title="TVMaze", page_icon="🌐")

st.title("🌐 TVMaze")
st.markdown("""
TV Show Data

**URL:** [http://www.tvmaze.com/api](http://www.tvmaze.com/api)
""")
...
url = st.text_input("API Endpoint", "http://www.tvmaze.com/api")
