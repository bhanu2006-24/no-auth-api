...
st.set_page_config(page_title="Lua Decompiler", page_icon="🌐")

st.title("🌐 Lua Decompiler")
st.markdown("""
Online Lua 5.1 Decompiler

**URL:** [https://lua-decompiler.ferib.dev/](https://lua-decompiler.ferib.dev/)
""")
...
url = st.text_input("API Endpoint", "https://lua-decompiler.ferib.dev/")
