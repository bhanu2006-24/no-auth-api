...
st.set_page_config(page_title="Brazilian Chamber of Deputies Open Data", page_icon="🌐")

st.title("🌐 Brazilian Chamber of Deputies Open Data")
st.markdown("""
Provides legislative information in Apis XML and JSON, as well as files in various formats

**URL:** [https://dadosabertos.camara.leg.br/swagger/api.html](https://dadosabertos.camara.leg.br/swagger/api.html)
""")
...
url = st.text_input("API Endpoint", "https://dadosabertos.camara.leg.br/swagger/api.html")
