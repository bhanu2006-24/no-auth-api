...
st.set_page_config(page_title="MetaWeather", page_icon="🌐")

st.title("🌐 MetaWeather")
st.markdown("""
Weather

**URL:** [https://www.metaweather.com/api/](https://www.metaweather.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://www.metaweather.com/api/")
