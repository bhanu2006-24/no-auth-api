...
st.set_page_config(page_title="Fuck Off as a Service", page_icon="🌐")

st.title("🌐 Fuck Off as a Service")
st.markdown("""
Asks someone to fuck off

**URL:** [https://www.foaas.com](https://www.foaas.com)
""")
...
url = st.text_input("API Endpoint", "https://www.foaas.com")
