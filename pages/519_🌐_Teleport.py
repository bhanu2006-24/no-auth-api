...
st.set_page_config(page_title="Teleport", page_icon="🌐")

st.title("🌐 Teleport")
st.markdown("""
Quality of Life Data

**URL:** [https://developers.teleport.org/](https://developers.teleport.org/)
""")
...
url = st.text_input("API Endpoint", "https://developers.teleport.org/")
