...
st.set_page_config(page_title="Humanitarian Data Exchange", page_icon="🌐")

st.title("🌐 Humanitarian Data Exchange")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://data.humdata.org/")
