...
st.set_page_config(page_title="Pinball Map", page_icon="🌐")

st.title("🌐 Pinball Map")
st.markdown("""
A crowdsourced map of public pinball machines

**URL:** [https://pinballmap.com/api/v1/docs](https://pinballmap.com/api/v1/docs)
""")
...
url = st.text_input("API Endpoint", "https://pinballmap.com/api/v1/docs")
