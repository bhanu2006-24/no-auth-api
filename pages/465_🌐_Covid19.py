...
**URL:** [https://github.com/M-Media-Group/Covid-19-API](https://github.com/M-Media-Group/Covid-19-API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/M-Media-Group/Covid-19-API")
