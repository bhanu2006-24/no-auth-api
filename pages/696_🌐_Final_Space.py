...
st.set_page_config(page_title="Final Space", page_icon="🌐")

st.title("🌐 Final Space")
st.markdown("""
Final Space API

**URL:** [https://finalspaceapi.com/docs/](https://finalspaceapi.com/docs/)
""")
...
url = st.text_input("API Endpoint", "https://finalspaceapi.com/docs/")
