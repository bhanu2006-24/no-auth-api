...
st.set_page_config(page_title="Bob's Burgers", page_icon="🌐")

st.title("🌐 Bob's Burgers")
st.markdown("""
Bob's Burgers API

**URL:** [https://bobs-burgers-api-ui.herokuapp.com](https://bobs-burgers-api-ui.herokuapp.com)
""")
...
url = st.text_input("API Endpoint", "https://bobs-burgers-api-ui.herokuapp.com")
