...
st.set_page_config(page_title="JSON 2 JSONP", page_icon="🌐")

st.title("🌐 JSON 2 JSONP")
st.markdown("""
Convert JSON to JSONP (on-the-fly) for easy cross-domain data requests using client-side JavaScript

**URL:** [https://json2jsonp.com/](https://json2jsonp.com/)
""")
...
url = st.text_input("API Endpoint", "https://json2jsonp.com/")
