...
st.set_page_config(page_title="Wandbox", page_icon="🌐")

st.title("🌐 Wandbox")
st.markdown("""
Code compiler supporting 35+ languages mentioned at wandbox.org

**URL:** [https://github.com/melpon/wandbox/blob/master/kennel2/API.rst](https://github.com/melpon/wandbox/blob/master/kennel2/API.rst)
""")
...
url = st.text_input("API Endpoint", "https://github.com/melpon/wandbox/blob/master/kennel2/API.rst")
