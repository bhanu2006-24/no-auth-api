...
st.set_page_config(page_title="GW2Spidy", page_icon="🌐")

st.title("🌐 GW2Spidy")
st.markdown("""
GW2Spidy API, Items data on the Guild Wars 2 Trade Market

**URL:** [https://github.com/rubensayshi/gw2spidy/wiki](https://github.com/rubensayshi/gw2spidy/wiki)
""")
...
url = st.text_input("API Endpoint", "https://github.com/rubensayshi/gw2spidy/wiki")
