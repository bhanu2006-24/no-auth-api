...
st.set_page_config(page_title="Open Government, Czech Republic", page_icon="🌐")

st.title("🌐 Open Government, Czech Republic")
st.markdown("""
Czech Republic Government Open Data

**URL:** [https://data.gov.cz/english/](https://data.gov.cz/english/)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.cz/english/")
