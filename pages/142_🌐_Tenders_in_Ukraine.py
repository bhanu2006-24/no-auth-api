...
st.set_page_config(page_title="Tenders in Ukraine", page_icon="🌐")

st.title("🌐 Tenders in Ukraine")
st.markdown("""
Get data for procurements in Ukraine in JSON format

**URL:** [https://tenders.guru/ua/api](https://tenders.guru/ua/api)
""")
...
url = st.text_input("API Endpoint", "https://tenders.guru/ua/api")
