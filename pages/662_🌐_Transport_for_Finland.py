...
st.set_page_config(page_title="Transport for Finland", page_icon="🌐")

st.title("🌐 Transport for Finland")
st.markdown("""
Finnish transport API

**URL:** [https://digitransit.fi/en/developers/](https://digitransit.fi/en/developers/)
""")
...
url = st.text_input("API Endpoint", "https://digitransit.fi/en/developers/")
