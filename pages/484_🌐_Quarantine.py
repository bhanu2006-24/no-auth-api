...
st.set_page_config(page_title="Quarantine", page_icon="🌐")

st.title("🌐 Quarantine")
st.markdown("""
Coronavirus API with free COVID-19 live updates

**URL:** [https://quarantine.country/coronavirus/api/](https://quarantine.country/coronavirus/api/)
""")
...
url = st.text_input("API Endpoint", "https://quarantine.country/coronavirus/api/")
