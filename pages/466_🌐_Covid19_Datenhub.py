...
st.set_page_config(page_title="Covid-19 Datenhub", page_icon="🌐")

st.title("🌐 Covid-19 Datenhub")
st.markdown("""
Maps, datasets, applications and more in the context of COVID-19

**URL:** [https://npgeo-corona-npgeo-de.hub.arcgis.com](https://npgeo-corona-npgeo-de.hub.arcgis.com)
""")
...
url = st.text_input("API Endpoint", "https://npgeo-corona-npgeo-de.hub.arcgis.com")
