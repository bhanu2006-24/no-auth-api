...
st.set_page_config(page_title="Guerrilla Mail", page_icon="🌐")

st.title("🌐 Guerrilla Mail")
st.markdown("""
Disposable temporary Email addresses

**URL:** [https://www.guerrillamail.com/GuerrillaMailAPI.html](https://www.guerrillamail.com/GuerrillaMailAPI.html)
""")
...
url = st.text_input("API Endpoint", "https://www.guerrillamail.com/GuerrillaMailAPI.html")
