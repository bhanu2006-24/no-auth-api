...
st.set_page_config(page_title="Psychonauts", page_icon="🌐")

st.title("🌐 Psychonauts")
st.markdown("""
Psychonauts World Characters Information and PSI Powers

**URL:** [https://psychonauts-api.netlify.app/](https://psychonauts-api.netlify.app/)
""")
...
url = st.text_input("API Endpoint", "https://psychonauts-api.netlify.app/")
