...
st.set_page_config(page_title="Hong Kong Obervatory", page_icon="🌐")

st.title("🌐 Hong Kong Obervatory")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://www.hko.gov.hk/en/abouthko/opendata_intro.htm")
