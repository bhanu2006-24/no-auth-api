...
st.set_page_config(page_title="Valorant (non-official)", page_icon="🌐")

st.title("🌐 Valorant (non-official)")
st.markdown("""
An extensive API containing data of most Valorant in-game items, assets and more

**URL:** [https://valorant-api.com](https://valorant-api.com)
""")
...
url = st.text_input("API Endpoint", "https://valorant-api.com")
