...
st.set_page_config(page_title="Transport for United States", page_icon="🌐")

st.title("🌐 Transport for United States")
st.markdown("""
NextBus API

**URL:** [https://retro.umoiq.com/xmlFeedDocs/NextBusXMLFeed.pdf](https://retro.umoiq.com/xmlFeedDocs/NextBusXMLFeed.pdf)
""")
...
url = st.text_input("API Endpoint", "https://retro.umoiq.com/xmlFeedDocs/NextBusXMLFeed.pdf")
