...
st.set_page_config(page_title="MLB Records and Stats", page_icon="🌐")

st.title("🌐 MLB Records and Stats")
st.markdown("""
Current and historical MLB statistics

**URL:** [https://appac.github.io/mlb-data-api-docs/](https://appac.github.io/mlb-data-api-docs/)
""")
...
url = st.text_input("API Endpoint", "https://appac.github.io/mlb-data-api-docs/")
