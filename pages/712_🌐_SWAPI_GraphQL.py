...
st.set_page_config(page_title="SWAPI GraphQL", page_icon="🌐")

st.title("🌐 SWAPI GraphQL")
st.markdown("""
Star Wars GraphQL API

**URL:** [https://graphql.org/swapi-graphql](https://graphql.org/swapi-graphql)
""")
...
url = st.text_input("API Endpoint", "https://graphql.org/swapi-graphql")
