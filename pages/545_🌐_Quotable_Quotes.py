...
st.set_page_config(page_title="Quotable Quotes", page_icon="🌐")

st.title("🌐 Quotable Quotes")
st.markdown("""
Quotable is a free, open source quotations API

**URL:** [https://github.com/lukePeavey/quotable](https://github.com/lukePeavey/quotable)
""")
...
url = st.text_input("API Endpoint", "https://github.com/lukePeavey/quotable")
