...
st.set_page_config(page_title="Sakura CardCaptor", page_icon="🌐")

st.title("🌐 Sakura CardCaptor")
st.markdown("""
Sakura CardCaptor Cards Information

**URL:** [https://github.com/JessVel/sakura-card-captor-api](https://github.com/JessVel/sakura-card-captor-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/JessVel/sakura-card-captor-api")
