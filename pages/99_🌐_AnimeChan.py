...
**URL:** [https://github.com/RocktimSaikia/anime-chan](https://github.com/RocktimSaikia/anime-chan)
""")
...
url = st.text_input("API Endpoint", "https://github.com/RocktimSaikia/anime-chan")
