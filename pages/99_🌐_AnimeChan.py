...
st.title("🌐 AnimeChan")
st.markdown("""
Explore the AnimeChan API.

**URL:** [https://api.animechan.io/v1/quotes/random](https://api.animechan.io/v1/quotes/random)
""")
...
url = st.text_input("API Endpoint", "https://api.animechan.io/v1/quotes/random")
