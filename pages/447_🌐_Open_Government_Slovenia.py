...
st.set_page_config(page_title="Open Government, Slovenia", page_icon="🌐")

st.title("🌐 Open Government, Slovenia")
st.markdown("""
Slovenia Government Open Data

**URL:** [https://podatki.gov.si/](https://podatki.gov.si/)
""")
...
url = st.text_input("API Endpoint", "https://podatki.gov.si/")
