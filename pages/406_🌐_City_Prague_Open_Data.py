...
st.set_page_config(page_title="City, Prague Open Data", page_icon="🌐")

st.title("🌐 City, Prague Open Data")
st.markdown("""
Prague(CZ) City Open Data

**URL:** [http://opendata.praha.eu/en](http://opendata.praha.eu/en)
""")
...
url = st.text_input("API Endpoint", "http://opendata.praha.eu/en")
