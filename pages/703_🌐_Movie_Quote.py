...
st.set_page_config(page_title="Movie Quote", page_icon="🌐")

st.title("🌐 Movie Quote")
st.markdown("""
Random Movie and Series Quotes

**URL:** [https://github.com/F4R4N/movie-quote/](https://github.com/F4R4N/movie-quote/)
""")
...
url = st.text_input("API Endpoint", "https://github.com/F4R4N/movie-quote/")
