...
st.set_page_config(page_title="Stranger Things Quotes", page_icon="🌐")

st.title("🌐 Stranger Things Quotes")
st.markdown("""
Returns Stranger Things quotes

**URL:** [https://github.com/shadowoff09/strangerthings-quotes](https://github.com/shadowoff09/strangerthings-quotes)
""")
...
url = st.text_input("API Endpoint", "https://github.com/shadowoff09/strangerthings-quotes")
