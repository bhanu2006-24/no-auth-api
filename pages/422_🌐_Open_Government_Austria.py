...
st.set_page_config(page_title="Open Government, Austria", page_icon="🌐")

st.title("🌐 Open Government, Austria")
st.markdown("""
Austria Government Open Data

**URL:** [https://www.data.gv.at/](https://www.data.gv.at/)
""")
...
url = st.text_input("API Endpoint", "https://www.data.gv.at/")
