...
st.set_page_config(page_title="Transport for Belgium", page_icon="🌐")

st.title("🌐 Transport for Belgium")
st.markdown("""
The iRail API is a third-party API for Belgian public transport by train

**URL:** [https://docs.irail.be/](https://docs.irail.be/)
""")
...
url = st.text_input("API Endpoint", "https://docs.irail.be/")
