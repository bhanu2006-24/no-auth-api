...
st.set_page_config(page_title="Open Government, Saudi Arabia", page_icon="🌐")

st.title("🌐 Open Government, Saudi Arabia")
st.markdown("""
Saudi Arabia Government Open Data

**URL:** [https://data.gov.sa](https://data.gov.sa)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.sa")
