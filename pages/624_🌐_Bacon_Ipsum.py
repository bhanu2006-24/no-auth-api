...
st.set_page_config(page_title="Bacon Ipsum", page_icon="🌐")

st.title("🌐 Bacon Ipsum")
st.markdown("""
A Meatier Lorem Ipsum Generator

**URL:** [https://baconipsum.com/json-api/](https://baconipsum.com/json-api/)
""")
...
url = st.text_input("API Endpoint", "https://baconipsum.com/json-api/")
