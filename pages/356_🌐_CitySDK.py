...
st.set_page_config(page_title="CitySDK", page_icon="🌐")

st.title("🌐 CitySDK")
st.markdown("""
Open APIs for select European cities

**URL:** [http://www.citysdk.eu/citysdk-toolkit/](http://www.citysdk.eu/citysdk-toolkit/)
""")
...
url = st.text_input("API Endpoint", "http://www.citysdk.eu/citysdk-toolkit/")
