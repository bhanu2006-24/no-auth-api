...
st.set_page_config(page_title="Corporate Buzz Words", page_icon="🌐")

st.title("🌐 Corporate Buzz Words")
st.markdown("""
REST API for Corporate Buzz Words

**URL:** [https://github.com/sameerkumar18/corporate-bs-generator-api](https://github.com/sameerkumar18/corporate-bs-generator-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/sameerkumar18/corporate-bs-generator-api")
