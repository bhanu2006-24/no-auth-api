...
st.set_page_config(page_title="Icelandic APIs", page_icon="🌐")

st.title("🌐 Icelandic APIs")
st.markdown("""
Open APIs that deliver services in or regarding Iceland

**URL:** [http://docs.apis.is/](http://docs.apis.is/)
""")
...
url = st.text_input("API Endpoint", "http://docs.apis.is/")
