...
st.set_page_config(page_title="Covid-19 Government Response", page_icon="🌐")

st.title("🌐 Covid-19 Government Response")
st.markdown("""
Government measures tracker to fight against the Covid-19 pandemic

**URL:** [https://covidtracker.bsg.ox.ac.uk](https://covidtracker.bsg.ox.ac.uk)
""")
...
url = st.text_input("API Endpoint", "https://covidtracker.bsg.ox.ac.uk")
