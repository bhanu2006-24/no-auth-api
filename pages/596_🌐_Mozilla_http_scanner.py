...
st.set_page_config(page_title="Mozilla http scanner", page_icon="🌐")

st.title("🌐 Mozilla http scanner")
st.markdown("""
Mozilla observatory http scanner

**URL:** [https://github.com/mozilla/http-observatory/blob/master/httpobs/docs/api.md](https://github.com/mozilla/http-observatory/blob/master/httpobs/docs/api.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/mozilla/http-observatory/blob/master/httpobs/docs/api.md")
