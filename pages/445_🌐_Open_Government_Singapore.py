...
st.set_page_config(page_title="Open Government, Singapore", page_icon="🌐")

st.title("🌐 Open Government, Singapore")
st.markdown("""
Singapore Government Open Data

**URL:** [https://data.gov.sg/developer](https://data.gov.sg/developer)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.sg/developer")
