...
st.title("🌐 Shibe.Online")
st.markdown("""
Explore the Shibe.Online API.

**URL:** [http://shibe.online/api/shibes?count=1](http://shibe.online/api/shibes?count=1)
""")
...
url = st.text_input("API Endpoint", "http://shibe.online/api/shibes?count=1")
