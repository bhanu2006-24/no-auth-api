...
st.set_page_config(page_title="GraphQL Jobs", page_icon="🌐")

st.title("🌐 GraphQL Jobs")
st.markdown("""
Jobs with GraphQL

**URL:** [https://graphql.jobs/docs/api/](https://graphql.jobs/docs/api/)
""")
...
url = st.text_input("API Endpoint", "https://graphql.jobs/docs/api/")
