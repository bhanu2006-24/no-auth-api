...
st.set_page_config(page_title="Chainpoint", page_icon="🌐")

st.title("🌐 Chainpoint")
st.markdown("""
Chainpoint is a global network for anchoring data to the Bitcoin blockchain

**URL:** [https://tierion.com/chainpoint/](https://tierion.com/chainpoint/)
""")
...
url = st.text_input("API Endpoint", "https://tierion.com/chainpoint/")
