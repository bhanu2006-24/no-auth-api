...
st.set_page_config(page_title="PokéAPI (GraphQL)", page_icon="🌐")

st.title("🌐 PokéAPI (GraphQL)")
st.markdown("""
The Unofficial GraphQL for PokeAPI

**URL:** [https://github.com/mazipan/graphql-pokeapi](https://github.com/mazipan/graphql-pokeapi)
""")
...
url = st.text_input("API Endpoint", "https://github.com/mazipan/graphql-pokeapi")
