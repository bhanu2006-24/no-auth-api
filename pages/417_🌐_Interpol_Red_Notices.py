...
st.set_page_config(page_title="Interpol Red Notices", page_icon="🌐")

st.title("🌐 Interpol Red Notices")
st.markdown("""
Access and search Interpol Red Notices

**URL:** [https://interpol.api.bund.dev/](https://interpol.api.bund.dev/)
""")
...
url = st.text_input("API Endpoint", "https://interpol.api.bund.dev/")
