...
st.set_page_config(page_title="Imsea", page_icon="🌐")

st.title("🌐 Imsea")
st.markdown("""
Free image search

**URL:** [https://imsea.herokuapp.com/](https://imsea.herokuapp.com/)
""")
...
url = st.text_input("API Endpoint", "https://imsea.herokuapp.com/")
