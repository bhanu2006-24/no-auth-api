...
st.set_page_config(page_title="Quotes on Design", page_icon="🌐")

st.title("🌐 Quotes on Design")
st.markdown("""
Inspirational Quotes

**URL:** [https://quotesondesign.com/api/](https://quotesondesign.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://quotesondesign.com/api/")
