...
st.set_page_config(page_title="Monster Hunter World", page_icon="🌐")

st.title("🌐 Monster Hunter World")
st.markdown("""
Monster Hunter World data

**URL:** [https://docs.mhw-db.com/](https://docs.mhw-db.com/)
""")
...
url = st.text_input("API Endpoint", "https://docs.mhw-db.com/")
