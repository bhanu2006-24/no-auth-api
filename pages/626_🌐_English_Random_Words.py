...
st.set_page_config(page_title="English Random Words", page_icon="🌐")

st.title("🌐 English Random Words")
st.markdown("""
Generate English Random Words with Pronunciation

**URL:** [https://random-words-api.vercel.app/word](https://random-words-api.vercel.app/word)
""")
...
url = st.text_input("API Endpoint", "https://random-words-api.vercel.app/word")
