...
st.set_page_config(page_title="Open Government, Australia", page_icon="🌐")

st.title("🌐 Open Government, Australia")
st.markdown("""
Australian Government Open Data

**URL:** [https://www.data.gov.au/](https://www.data.gov.au/)
""")
...
url = st.text_input("API Endpoint", "https://www.data.gov.au/")
