...
st.set_page_config(page_title="Danish data service Energi", page_icon="🌐")

st.title("🌐 Danish data service Energi")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://www.energidataservice.dk/")
