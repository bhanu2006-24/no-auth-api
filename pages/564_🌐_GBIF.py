...
st.set_page_config(page_title="GBIF", page_icon="🌐")

st.title("🌐 GBIF")
st.markdown("""
Global Biodiversity Information Facility

**URL:** [https://www.gbif.org/developer/summary](https://www.gbif.org/developer/summary)
""")
...
url = st.text_input("API Endpoint", "https://www.gbif.org/developer/summary")
