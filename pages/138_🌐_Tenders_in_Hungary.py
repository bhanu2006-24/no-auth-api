...
st.set_page_config(page_title="Tenders in Hungary", page_icon="🌐")

st.title("🌐 Tenders in Hungary")
st.markdown("""
Get data for procurements in Hungary in JSON format

**URL:** [https://tenders.guru/hu/api](https://tenders.guru/hu/api)
""")
...
url = st.text_input("API Endpoint", "https://tenders.guru/hu/api")
