...
st.set_page_config(page_title="Localbitcoins", page_icon="🌐")

st.title("🌐 Localbitcoins")
st.markdown("""
P2P platform to buy and sell Bitcoins

**URL:** [https://localbitcoins.com/api-docs/](https://localbitcoins.com/api-docs/)
""")
...
url = st.text_input("API Endpoint", "https://localbitcoins.com/api-docs/")
