...
st.set_page_config(page_title="TETR.IO", page_icon="🌐")

st.title("🌐 TETR.IO")
st.markdown("""
TETR.IO Tetra Channel API

**URL:** [https://tetr.io/about/api/](https://tetr.io/about/api/)
""")
...
url = st.text_input("API Endpoint", "https://tetr.io/about/api/")
