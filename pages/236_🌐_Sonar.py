...
st.set_page_config(page_title="Sonar", page_icon="🌐")

st.title("🌐 Sonar")
st.markdown("""
Project Sonar DNS Enumeration API

**URL:** [https://github.com/Cgboal/SonarSearch](https://github.com/Cgboal/SonarSearch)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Cgboal/SonarSearch")
