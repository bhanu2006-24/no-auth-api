...
st.set_page_config(page_title="Wiktionary", page_icon="🌐")

st.title("🌐 Wiktionary")
st.markdown("""
Collaborative dictionary data

**URL:** [https://en.wiktionary.org/w/api.php](https://en.wiktionary.org/w/api.php)
""")
...
url = st.text_input("API Endpoint", "https://en.wiktionary.org/w/api.php")
