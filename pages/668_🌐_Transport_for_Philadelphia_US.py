...
st.set_page_config(page_title="Transport for Philadelphia, US", page_icon="🌐")

st.title("🌐 Transport for Philadelphia, US")
st.markdown("""
SEPTA APIs

**URL:** [http://www3.septa.org/hackathon/](http://www3.septa.org/hackathon/)
""")
...
url = st.text_input("API Endpoint", "http://www3.septa.org/hackathon/")
