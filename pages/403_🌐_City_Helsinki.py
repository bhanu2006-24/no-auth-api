...
st.set_page_config(page_title="City, Helsinki", page_icon="🌐")

st.title("🌐 City, Helsinki")
st.markdown("""
Helsinki(FI) City Open Data

**URL:** [https://hri.fi/en_gb/](https://hri.fi/en_gb/)
""")
...
url = st.text_input("API Endpoint", "https://hri.fi/en_gb/")
