...
st.title("🌐 Hebrew Calendar")
st.markdown("""
Convert between Gregorian and Hebrew, fetch Shabbat and Holiday times, etc

**URL:** [https://www.hebcal.com/home/developer-apis](https://www.hebcal.com/home/developer-apis)
""")
...
url = st.text_input("API Endpoint", "https://www.hebcal.com/home/developer-apis")
