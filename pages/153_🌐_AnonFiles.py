...
st.set_page_config(page_title="AnonFiles", page_icon="🌐")

st.title("🌐 AnonFiles")
st.markdown("""
Upload and share your files anonymously

**URL:** [https://anonfiles.com/docs/api](https://anonfiles.com/docs/api)
""")
...
url = st.text_input("API Endpoint", "https://anonfiles.com/docs/api")
