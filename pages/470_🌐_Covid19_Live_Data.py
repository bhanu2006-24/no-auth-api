...
st.set_page_config(page_title="Covid-19 Live Data", page_icon="🌐")

st.title("🌐 Covid-19 Live Data")
st.markdown("""
Global and countrywise data of Covid 19 daily Summary, confirmed cases, recovered and deaths

**URL:** [https://github.com/mathdroid/covid-19-api](https://github.com/mathdroid/covid-19-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/mathdroid/covid-19-api")
