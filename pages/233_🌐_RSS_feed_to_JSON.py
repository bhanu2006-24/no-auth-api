...
st.set_page_config(page_title="RSS feed to JSON", page_icon="🌐")

st.title("🌐 RSS feed to JSON")
st.markdown("""
Returns RSS feed in JSON format using feed URL

**URL:** [https://rss-to-json-serverless-api.vercel.app](https://rss-to-json-serverless-api.vercel.app)
""")
...
url = st.text_input("API Endpoint", "https://rss-to-json-serverless-api.vercel.app")
