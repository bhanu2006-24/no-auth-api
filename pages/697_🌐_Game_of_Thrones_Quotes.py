...
st.set_page_config(page_title="Game of Thrones Quotes", page_icon="🌐")

st.title("🌐 Game of Thrones Quotes")
st.markdown("""
Some Game of Thrones quotes

**URL:** [https://gameofthronesquotes.xyz/](https://gameofthronesquotes.xyz/)
""")
...
url = st.text_input("API Endpoint", "https://gameofthronesquotes.xyz/")
