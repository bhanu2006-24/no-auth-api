...
st.set_page_config(page_title="xMath", page_icon="🌐")

st.title("🌐 xMath")
st.markdown("""
Random mathematical expressions

**URL:** [https://x-math.herokuapp.com/](https://x-math.herokuapp.com/)
""")
...
url = st.text_input("API Endpoint", "https://x-math.herokuapp.com/")
