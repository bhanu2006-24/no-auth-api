...
st.set_page_config(page_title="Harry Potter Charactes", page_icon="🌐")

st.title("🌐 Harry Potter Charactes")
st.markdown("""
Harry Potter Characters Data with with imagery

**URL:** [https://hp-api.herokuapp.com/](https://hp-api.herokuapp.com/)
""")
...
url = st.text_input("API Endpoint", "https://hp-api.herokuapp.com/")
