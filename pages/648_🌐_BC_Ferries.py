...
st.set_page_config(page_title="BC Ferries", page_icon="🌐")

st.title("🌐 BC Ferries")
st.markdown("""
Sailing times and capacities for BC Ferries

**URL:** [https://www.bcferriesapi.ca](https://www.bcferriesapi.ca)
""")
...
url = st.text_input("API Endpoint", "https://www.bcferriesapi.ca")
