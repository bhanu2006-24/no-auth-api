...
st.set_page_config(page_title="chucknorris.io", page_icon="🌐")

st.title("🌐 chucknorris.io")
st.markdown("""
JSON API for hand curated Chuck Norris jokes

**URL:** [https://api.chucknorris.io](https://api.chucknorris.io)
""")
...
url = st.text_input("API Endpoint", "https://api.chucknorris.io")
