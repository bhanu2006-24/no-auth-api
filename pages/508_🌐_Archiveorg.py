...
st.set_page_config(page_title="Archive.org", page_icon="🌐")

st.title("🌐 Archive.org")
st.markdown("""
The Internet Archive

**URL:** [https://archive.readme.io/docs](https://archive.readme.io/docs)
""")
...
url = st.text_input("API Endpoint", "https://archive.readme.io/docs")
