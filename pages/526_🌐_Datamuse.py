...
st.set_page_config(page_title="Datamuse", page_icon="🌐")

st.title("🌐 Datamuse")
st.markdown("""
Word-finding query engine

**URL:** [https://www.datamuse.com/api/](https://www.datamuse.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://www.datamuse.com/api/")
