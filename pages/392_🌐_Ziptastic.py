...
st.set_page_config(page_title="Ziptastic", page_icon="🌐")

st.title("🌐 Ziptastic")
st.markdown("""
Get the country, state, and city of any US zip-code

**URL:** [https://ziptasticapi.com/](https://ziptasticapi.com/)
""")
...
url = st.text_input("API Endpoint", "https://ziptasticapi.com/")
