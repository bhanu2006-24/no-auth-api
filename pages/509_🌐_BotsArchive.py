...
st.set_page_config(page_title="BotsArchive", page_icon="🌐")

st.title("🌐 BotsArchive")
st.markdown("""
JSON formatted details about Telegram Bots available in database

**URL:** [https://botsarchive.com/docs.html](https://botsarchive.com/docs.html)
""")
...
url = st.text_input("API Endpoint", "https://botsarchive.com/docs.html")
