...
st.set_page_config(page_title="Mozilla tls scanner", page_icon="🌐")

st.title("🌐 Mozilla tls scanner")
st.markdown("""
Mozilla observatory tls scanner

**URL:** [https://github.com/mozilla/tls-observatory#api-endpoints](https://github.com/mozilla/tls-observatory#api-endpoints)
""")
...
url = st.text_input("API Endpoint", "https://github.com/mozilla/tls-observatory#api-endpoints")
