...
st.set_page_config(page_title="KONTESTS", page_icon="🌐")

st.title("🌐 KONTESTS")
st.markdown("""
For upcoming and ongoing competitive coding contests

**URL:** [https://kontests.net/api](https://kontests.net/api)
""")
...
url = st.text_input("API Endpoint", "https://kontests.net/api")
