...
st.set_page_config(page_title="TransitLand", page_icon="🌐")

st.title("🌐 TransitLand")
st.markdown("""
Transit Aggregation

**URL:** [https://www.transit.land/documentation/datastore/api-endpoints.html](https://www.transit.land/documentation/datastore/api-endpoints.html)
""")
...
url = st.text_input("API Endpoint", "https://www.transit.land/documentation/datastore/api-endpoints.html")
