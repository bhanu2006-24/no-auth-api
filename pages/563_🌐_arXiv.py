...
st.set_page_config(page_title="arXiv", page_icon="🌐")

st.title("🌐 arXiv")
st.markdown("""
Curated research-sharing platform: physics, mathematics, quantitative finance, and economics

**URL:** [https://arxiv.org/help/api/user-manual](https://arxiv.org/help/api/user-manual)
""")
...
url = st.text_input("API Endpoint", "https://arxiv.org/help/api/user-manual")
