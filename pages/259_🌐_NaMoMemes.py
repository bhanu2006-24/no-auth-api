...
st.set_page_config(page_title="NaMoMemes", page_icon="🌐")

st.title("🌐 NaMoMemes")
st.markdown("""
Memes on Narendra Modi

**URL:** [https://github.com/theIYD/NaMoMemes](https://github.com/theIYD/NaMoMemes)
""")
...
url = st.text_input("API Endpoint", "https://github.com/theIYD/NaMoMemes")
