...
st.set_page_config(page_title="Puyo Nexus", page_icon="🌐")

st.title("🌐 Puyo Nexus")
st.markdown("""
Puyo Puyo information from Puyo Nexus Wiki

**URL:** [https://github.com/deltadex7/puyodb-api-deno](https://github.com/deltadex7/puyodb-api-deno)
""")
...
url = st.text_input("API Endpoint", "https://github.com/deltadex7/puyodb-api-deno")
