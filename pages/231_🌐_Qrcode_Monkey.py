...
st.set_page_config(page_title="Qrcode Monkey", page_icon="🌐")

st.title("🌐 Qrcode Monkey")
st.markdown("""
Integrate custom and unique looking QR codes into your system or workflow

**URL:** [https://www.qrcode-monkey.com/qr-code-api-with-logo/](https://www.qrcode-monkey.com/qr-code-api-with-logo/)
""")
...
url = st.text_input("API Endpoint", "https://www.qrcode-monkey.com/qr-code-api-with-logo/")
