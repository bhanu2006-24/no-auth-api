...
st.set_page_config(page_title="City, Toronto Open Data", page_icon="🌐")

st.title("🌐 City, Toronto Open Data")
st.markdown("""
Toronto (CA) City Open Data

**URL:** [https://open.toronto.ca/](https://open.toronto.ca/)
""")
...
url = st.text_input("API Endpoint", "https://open.toronto.ca/")
