...
st.set_page_config(page_title="EmailRep", page_icon="🌐")

st.title("🌐 EmailRep")
st.markdown("""
Email address threat and risk prediction

**URL:** [https://docs.emailrep.io/](https://docs.emailrep.io/)
""")
...
url = st.text_input("API Endpoint", "https://docs.emailrep.io/")
