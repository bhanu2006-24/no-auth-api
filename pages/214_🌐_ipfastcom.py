...
st.set_page_config(page_title="ip-fast.com", page_icon="🌐")

st.title("🌐 ip-fast.com")
st.markdown("""
IP address, country and city

**URL:** [https://ip-fast.com/docs/](https://ip-fast.com/docs/)
""")
...
url = st.text_input("API Endpoint", "https://ip-fast.com/docs/")
