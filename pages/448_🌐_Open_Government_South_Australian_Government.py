...
st.set_page_config(page_title="Open Government, South Australian Government", page_icon="🌐")

st.title("🌐 Open Government, South Australian Government")
st.markdown("""
South Australian Government Open Data

**URL:** [https://data.sa.gov.au/](https://data.sa.gov.au/)
""")
...
url = st.text_input("API Endpoint", "https://data.sa.gov.au/")
