...
st.set_page_config(page_title="Food Standards Agency", page_icon="🌐")

st.title("🌐 Food Standards Agency")
st.markdown("""
UK food hygiene rating data API

**URL:** [http://ratings.food.gov.uk/open-data/en-GB](http://ratings.food.gov.uk/open-data/en-GB)
""")
...
url = st.text_input("API Endpoint", "http://ratings.food.gov.uk/open-data/en-GB")
