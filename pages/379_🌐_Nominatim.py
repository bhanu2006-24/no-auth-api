...
st.set_page_config(page_title="Nominatim", page_icon="🌐")

st.title("🌐 Nominatim")
st.markdown("""
Provides worldwide forward / reverse geocoding

**URL:** [https://nominatim.org/release-docs/latest/api/Overview/](https://nominatim.org/release-docs/latest/api/Overview/)
""")
...
url = st.text_input("API Endpoint", "https://nominatim.org/release-docs/latest/api/Overview/")
