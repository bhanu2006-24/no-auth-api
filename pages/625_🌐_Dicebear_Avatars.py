...
st.set_page_config(page_title="Dicebear Avatars", page_icon="🌐")

st.title("🌐 Dicebear Avatars")
st.markdown("""
Generate random pixel-art avatars

**URL:** [https://avatars.dicebear.com/](https://avatars.dicebear.com/)
""")
...
url = st.text_input("API Endpoint", "https://avatars.dicebear.com/")
