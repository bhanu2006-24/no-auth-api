...
**URL:** [https://www.cryptingup.com/apidoc/#introduction](https://www.cryptingup.com/apidoc/#introduction)
""")
...
url = st.text_input("API Endpoint", "https://www.cryptingup.com/apidoc/#introduction")
