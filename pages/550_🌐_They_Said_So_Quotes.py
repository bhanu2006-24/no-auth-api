...
st.set_page_config(page_title="They Said So Quotes", page_icon="🌐")

st.title("🌐 They Said So Quotes")
st.markdown("""
Quotes Trusted by many fortune brands around the world

**URL:** [https://theysaidso.com/api/](https://theysaidso.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://theysaidso.com/api/")
