...
st.set_page_config(page_title="COVID-19 Tracker Canada", page_icon="🌐")

st.title("🌐 COVID-19 Tracker Canada")
st.markdown("""
Details on Covid-19 cases across Canada

**URL:** [https://api.covid19tracker.ca/docs/1.0/overview](https://api.covid19tracker.ca/docs/1.0/overview)
""")
...
url = st.text_input("API Endpoint", "https://api.covid19tracker.ca/docs/1.0/overview")
