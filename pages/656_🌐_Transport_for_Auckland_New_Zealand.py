...
st.set_page_config(page_title="Transport for Auckland, New Zealand", page_icon="🌐")

st.title("🌐 Transport for Auckland, New Zealand")
st.markdown("""
Auckland Transport

**URL:** [https://dev-portal.at.govt.nz/](https://dev-portal.at.govt.nz/)
""")
...
url = st.text_input("API Endpoint", "https://dev-portal.at.govt.nz/")
