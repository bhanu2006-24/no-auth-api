...
st.set_page_config(page_title="Geocode.xyz", page_icon="🌐")

st.title("🌐 Geocode.xyz")
st.markdown("""
Provides worldwide forward/reverse geocoding, batch geocoding and geoparsing

**URL:** [https://geocode.xyz/api](https://geocode.xyz/api)
""")
...
url = st.text_input("API Endpoint", "https://geocode.xyz/api")
