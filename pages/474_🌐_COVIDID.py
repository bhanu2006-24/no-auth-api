...
st.set_page_config(page_title="COVID-ID", page_icon="🌐")

st.title("🌐 COVID-ID")
st.markdown("""
Indonesian government Covid data per province

**URL:** [https://data.covid19.go.id/public/api/prov.json](https://data.covid19.go.id/public/api/prov.json)
""")
...
url = st.text_input("API Endpoint", "https://data.covid19.go.id/public/api/prov.json")
