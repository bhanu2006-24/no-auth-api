...
st.set_page_config(page_title="JSONPlaceholder", page_icon="🌐")

st.title("🌐 JSONPlaceholder")
st.markdown("""
Fake data for testing and prototyping

**URL:** [http://jsonplaceholder.typicode.com/](http://jsonplaceholder.typicode.com/)
""")
...
url = st.text_input("API Endpoint", "http://jsonplaceholder.typicode.com/")
