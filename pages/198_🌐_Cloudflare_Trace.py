...
st.set_page_config(page_title="Cloudflare Trace", page_icon="🌐")

st.title("🌐 Cloudflare Trace")
st.markdown("""
Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More

**URL:** [https://github.com/fawazahmed0/cloudflare-trace-api](https://github.com/fawazahmed0/cloudflare-trace-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/fawazahmed0/cloudflare-trace-api")
