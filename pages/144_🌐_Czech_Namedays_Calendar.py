...
st.set_page_config(page_title="Czech Namedays Calendar", page_icon="🌐")

st.title("🌐 Czech Namedays Calendar")
st.markdown("""
Lookup for a name and returns nameday date

**URL:** [https://svatky.adresa.info](https://svatky.adresa.info)
""")
...
url = st.text_input("API Endpoint", "https://svatky.adresa.info")
