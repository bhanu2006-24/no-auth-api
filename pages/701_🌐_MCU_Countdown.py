...
st.set_page_config(page_title="MCU Countdown", page_icon="🌐")

st.title("🌐 MCU Countdown")
st.markdown("""
A Countdown to the next MCU Film

**URL:** [https://github.com/DiljotSG/MCU-Countdown](https://github.com/DiljotSG/MCU-Countdown)
""")
...
url = st.text_input("API Endpoint", "https://github.com/DiljotSG/MCU-Countdown")
