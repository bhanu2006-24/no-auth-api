...
st.set_page_config(page_title="IP Vigilante", page_icon="🌐")

st.title("🌐 IP Vigilante")
st.markdown("""
Free IP Geolocation API

**URL:** [https://www.ipvigilante.com/](https://www.ipvigilante.com/)
""")
...
url = st.text_input("API Endpoint", "https://www.ipvigilante.com/")
