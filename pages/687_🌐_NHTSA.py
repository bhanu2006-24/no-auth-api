...
st.set_page_config(page_title="NHTSA", page_icon="🌐")

st.title("🌐 NHTSA")
st.markdown("""
NHTSA Product Information Catalog and Vehicle Listing

**URL:** [https://vpic.nhtsa.dot.gov/api/](https://vpic.nhtsa.dot.gov/api/)
""")
...
url = st.text_input("API Endpoint", "https://vpic.nhtsa.dot.gov/api/")
