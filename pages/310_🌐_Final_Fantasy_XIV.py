...
st.set_page_config(page_title="Final Fantasy XIV", page_icon="🌐")

st.title("🌐 Final Fantasy XIV")
st.markdown("""
Final Fantasy XIV Game data API

**URL:** [https://xivapi.com/](https://xivapi.com/)
""")
...
url = st.text_input("API Endpoint", "https://xivapi.com/")
