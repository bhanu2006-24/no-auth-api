...
st.set_page_config(page_title="Open Notify", page_icon="🌐")

st.title("🌐 Open Notify")
st.markdown("""
ISS astronauts, current location, etc

**URL:** [http://open-notify.org/Open-Notify-API/](http://open-notify.org/Open-Notify-API/)
""")
...
url = st.text_input("API Endpoint", "http://open-notify.org/Open-Notify-API/")
