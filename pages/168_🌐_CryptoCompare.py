...
st.set_page_config(page_title="CryptoCompare", page_icon="🌐")

st.title("🌐 CryptoCompare")
st.markdown("""
Cryptocurrencies Comparison

**URL:** [https://www.cryptocompare.com/api#](https://www.cryptocompare.com/api#)
""")
...
url = st.text_input("API Endpoint", "https://www.cryptocompare.com/api#")
