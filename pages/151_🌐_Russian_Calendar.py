...
st.title("🌐 Russian Calendar")
st.markdown("""
Check if a date is a Russian holiday or not

**URL:** [https://github.com/egno/work-calendar](https://github.com/egno/work-calendar)
""")
...
url = st.text_input("API Endpoint", "https://github.com/egno/work-calendar")
