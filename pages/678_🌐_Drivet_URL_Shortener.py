...
st.set_page_config(page_title="Drivet URL Shortener", page_icon="🌐")

st.title("🌐 Drivet URL Shortener")
st.markdown("""
Shorten a long URL easily and fast

**URL:** [https://wiki.drivet.xyz/en/url-shortener/add-links](https://wiki.drivet.xyz/en/url-shortener/add-links)
""")
...
url = st.text_input("API Endpoint", "https://wiki.drivet.xyz/en/url-shortener/add-links")
