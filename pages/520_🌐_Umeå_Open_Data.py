...
st.set_page_config(page_title="Umeå Open Data", page_icon="🌐")

st.title("🌐 Umeå Open Data")
st.markdown("""
Open data of the city Umeå in northen Sweden

**URL:** [https://opendata.umea.se/api/](https://opendata.umea.se/api/)
""")
...
url = st.text_input("API Endpoint", "https://opendata.umea.se/api/")
