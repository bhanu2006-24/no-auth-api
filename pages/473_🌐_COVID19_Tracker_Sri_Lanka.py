...
st.set_page_config(page_title="COVID-19 Tracker Sri Lanka", page_icon="🌐")

st.title("🌐 COVID-19 Tracker Sri Lanka")
st.markdown("""
Provides situation of the COVID-19 patients reported in Sri Lanka

**URL:** [https://www.hpb.health.gov.lk/en/api-documentation](https://www.hpb.health.gov.lk/en/api-documentation)
""")
...
url = st.text_input("API Endpoint", "https://www.hpb.health.gov.lk/en/api-documentation")
