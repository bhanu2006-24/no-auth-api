...
st.set_page_config(page_title="Spanish random names", page_icon="🌐")

st.title("🌐 Spanish random names")
st.markdown("""
Generate spanish names (with gender) randomly

**URL:** [https://random-names-api.herokuapp.com/public](https://random-names-api.herokuapp.com/public)
""")
...
url = st.text_input("API Endpoint", "https://random-names-api.herokuapp.com/public")
