...
st.set_page_config(page_title="Open Government, Lithuania", page_icon="🌐")

st.title("🌐 Open Government, Lithuania")
st.markdown("""
Lithuania Government Open Data

**URL:** [https://data.gov.lt/public/api/1](https://data.gov.lt/public/api/1)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.lt/public/api/1")
