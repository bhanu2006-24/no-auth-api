...
st.set_page_config(page_title="18F", page_icon="🌐")

st.title("🌐 18F")
st.markdown("""
Unofficial US Federal Government API Development

**URL:** [http://18f.github.io/API-All-the-X/](http://18f.github.io/API-All-the-X/)
""")
...
url = st.text_input("API Endpoint", "http://18f.github.io/API-All-the-X/")
