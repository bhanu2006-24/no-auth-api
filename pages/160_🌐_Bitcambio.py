...
**URL:** [https://nova.bitcambio.com.br/api/v3/docs#a-public](https://nova.bitcambio.com.br/api/v3/docs#a-public)
""")
...
url = st.text_input("API Endpoint", "https://nova.bitcambio.com.br/api/v3/docs#a-public")
