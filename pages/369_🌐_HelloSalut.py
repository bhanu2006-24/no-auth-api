...
st.set_page_config(page_title="HelloSalut", page_icon="🌐")

st.title("🌐 HelloSalut")
st.markdown("""
Get hello translation following user language

**URL:** [https://fourtonfish.com/project/hellosalut-api/](https://fourtonfish.com/project/hellosalut-api/)
""")
...
url = st.text_input("API Endpoint", "https://fourtonfish.com/project/hellosalut-api/")
