...
st.set_page_config(page_title="SEC EDGAR Data", page_icon="🌐")

st.title("🌐 SEC EDGAR Data")
st.markdown("""
API to access annual reports of public US companies

**URL:** [https://www.sec.gov/edgar/sec-api-documentation](https://www.sec.gov/edgar/sec-api-documentation)
""")
...
url = st.text_input("API Endpoint", "https://www.sec.gov/edgar/sec-api-documentation")
