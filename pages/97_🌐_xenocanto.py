...
st.title("🌐 xeno-canto")
st.markdown("""
Explore the xeno-canto API.

**URL:** [https://www.xeno-canto.org/api/2/recordings?query=cnt:brazil](https://www.xeno-canto.org/api/2/recordings?query=cnt:brazil)
""")
...
url = st.text_input("API Endpoint", "https://www.xeno-canto.org/api/2/recordings?query=cnt:brazil")
