...
st.set_page_config(page_title="Open Science Framework", page_icon="🌐")

st.title("🌐 Open Science Framework")
st.markdown("""
Repository and archive for study designs, research materials, data, manuscripts, etc

**URL:** [https://developer.osf.io](https://developer.osf.io)
""")
...
url = st.text_input("API Endpoint", "https://developer.osf.io")
