...
st.title("🌐 Economia.Awesome")
st.markdown("""
Portuguese free currency prices and conversion with no rate limits

**URL:** [https://docs.awesomeapi.com.br/api-de-moedas](https://docs.awesomeapi.com.br/api-de-moedas)
""")
...
url = st.text_input("API Endpoint", "https://docs.awesomeapi.com.br/api-de-moedas")
