...
st.set_page_config(page_title="Digimon Information", page_icon="🌐")

st.title("🌐 Digimon Information")
st.markdown("""
Provides information about digimon creatures

**URL:** [https://digimon-api.vercel.app/](https://digimon-api.vercel.app/)
""")
...
url = st.text_input("API Endpoint", "https://digimon-api.vercel.app/")
