...
st.set_page_config(page_title="Open Government, Switzerland", page_icon="🌐")

st.title("🌐 Open Government, Switzerland")
st.markdown("""
Switzerland Government Open Data

**URL:** [https://handbook.opendata.swiss/de/content/nutzen/api-nutzen.html](https://handbook.opendata.swiss/de/content/nutzen/api-nutzen.html)
""")
...
url = st.text_input("API Endpoint", "https://handbook.opendata.swiss/de/content/nutzen/api-nutzen.html")
