...
st.title("🌐 Programming Quotes")
st.markdown("""
Programming Quotes API for open source projects

**URL:** [https://github.com/skolakoda/programming-quotes-api](https://github.com/skolakoda/programming-quotes-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/skolakoda/programming-quotes-api")
