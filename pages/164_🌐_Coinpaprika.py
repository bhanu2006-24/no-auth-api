...
st.set_page_config(page_title="Coinpaprika", page_icon="🌐")

st.title("🌐 Coinpaprika")
st.markdown("""
Cryptocurrencies prices, volume and more

**URL:** [https://api.coinpaprika.com](https://api.coinpaprika.com)
""")
...
url = st.text_input("API Endpoint", "https://api.coinpaprika.com")
