...
st.set_page_config(page_title="Microsoft Security Response Center (MSRC)", page_icon="🌐")

st.title("🌐 Microsoft Security Response Center (MSRC)")
st.markdown("""
Programmatic interfaces to engage with the Microsoft Security Response Center (MSRC)

**URL:** [https://msrc.microsoft.com/report/developer](https://msrc.microsoft.com/report/developer)
""")
...
url = st.text_input("API Endpoint", "https://msrc.microsoft.com/report/developer")
