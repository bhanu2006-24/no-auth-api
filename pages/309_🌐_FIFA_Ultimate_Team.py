...
st.set_page_config(page_title="FIFA Ultimate Team", page_icon="🌐")

st.title("🌐 FIFA Ultimate Team")
st.markdown("""
FIFA Ultimate Team items API

**URL:** [https://www.easports.com/fifa/ultimate-team/api/fut/item](https://www.easports.com/fifa/ultimate-team/api/fut/item)
""")
...
url = st.text_input("API Endpoint", "https://www.easports.com/fifa/ultimate-team/api/fut/item")
