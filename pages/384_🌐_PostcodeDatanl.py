...
st.set_page_config(page_title="PostcodeData.nl", page_icon="🌐")

st.title("🌐 PostcodeData.nl")
st.markdown("""
Provide geolocation data based on postcode for Dutch addresses

**URL:** [http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json](http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json)
""")
...
url = st.text_input("API Endpoint", "http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json")
