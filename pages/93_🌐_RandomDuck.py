...
st.set_page_config(page_title="RandomDuck", page_icon="🌐")

st.title("🌐 RandomDuck")
st.markdown("""
Explore the RandomDuck API.

**URL:** [https://random-d.uk/api/v2/random](https://random-d.uk/api/v2/random)
""")
...
url = st.text_input("API Endpoint", "https://random-d.uk/api/v2/random")
