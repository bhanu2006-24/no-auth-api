...
st.set_page_config(page_title="UK Carbon Intensity", page_icon="🌐")

st.title("🌐 UK Carbon Intensity")
st.markdown("""
The Official Carbon Intensity API for Great Britain developed by National Grid

**URL:** [https://carbon-intensity.github.io/api-definitions/#carbon-intensity-api-v1-0-0](https://carbon-intensity.github.io/api-definitions/#carbon-intensity-api-v1-0-0)
""")
...
url = st.text_input("API Endpoint", "https://carbon-intensity.github.io/api-definitions/#carbon-intensity-api-v1-0-0")
