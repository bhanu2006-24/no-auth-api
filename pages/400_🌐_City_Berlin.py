...
st.set_page_config(page_title="City, Berlin", page_icon="🌐")

st.title("🌐 City, Berlin")
st.markdown("""
Berlin(DE) City Open Data

**URL:** [https://daten.berlin.de/](https://daten.berlin.de/)
""")
...
url = st.text_input("API Endpoint", "https://daten.berlin.de/")
