...
st.set_page_config(page_title="REFUGE Restrooms", page_icon="🌐")

st.title("🌐 REFUGE Restrooms")
st.markdown("""
Provides safe restroom access for transgender, intersex and gender nonconforming individuals

**URL:** [https://www.refugerestrooms.org/api/docs/#!/restrooms](https://www.refugerestrooms.org/api/docs/#!/restrooms)
""")
...
url = st.text_input("API Endpoint", "https://www.refugerestrooms.org/api/docs/#!/restrooms")
