...
st.set_page_config(page_title="openAFRICA", page_icon="🌐")

st.title("🌐 openAFRICA")
st.markdown("""
Large datasets repository of African open data

**URL:** [https://africaopendata.org/](https://africaopendata.org/)
""")
...
url = st.text_input("API Endpoint", "https://africaopendata.org/")
