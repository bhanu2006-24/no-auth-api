...
st.set_page_config(page_title="WhatPulse", page_icon="🌐")

st.title("🌐 WhatPulse")
st.markdown("""
Small application that measures your keyboard/mouse usage

**URL:** [https://developer.whatpulse.org/#web-api](https://developer.whatpulse.org/#web-api)
""")
...
url = st.text_input("API Endpoint", "https://developer.whatpulse.org/#web-api")
