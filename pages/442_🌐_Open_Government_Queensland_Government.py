...
st.set_page_config(page_title="Open Government, Queensland Government", page_icon="🌐")

st.title("🌐 Open Government, Queensland Government")
st.markdown("""
Queensland Government Open Data

**URL:** [https://www.data.qld.gov.au/](https://www.data.qld.gov.au/)
""")
...
url = st.text_input("API Endpoint", "https://www.data.qld.gov.au/")
