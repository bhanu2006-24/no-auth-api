...
st.set_page_config(page_title="Geodata.gov.gr", page_icon="🌐")

st.title("🌐 Geodata.gov.gr")
st.markdown("""
Open geospatial data and API service for Greece

**URL:** [https://geodata.gov.gr/en/](https://geodata.gov.gr/en/)
""")
...
url = st.text_input("API Endpoint", "https://geodata.gov.gr/en/")
