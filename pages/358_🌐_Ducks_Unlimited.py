...
st.set_page_config(page_title="Ducks Unlimited", page_icon="🌐")

st.title("🌐 Ducks Unlimited")
st.markdown("""
API explorer that gives a query URL with a JSON response of locations and cities

**URL:** [https://gis.ducks.org/datasets/du-university-chapters/api](https://gis.ducks.org/datasets/du-university-chapters/api)
""")
...
url = st.text_input("API Endpoint", "https://gis.ducks.org/datasets/du-university-chapters/api")
