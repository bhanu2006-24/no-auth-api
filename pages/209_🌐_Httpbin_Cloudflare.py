...
st.set_page_config(page_title="Httpbin Cloudflare", page_icon="🌐")

st.title("🌐 Httpbin Cloudflare")
st.markdown("""
A Simple HTTP Request & Response Service with HTTP/3 Support by Cloudflare

**URL:** [https://cloudflare-quic.com/b/](https://cloudflare-quic.com/b/)
""")
...
url = st.text_input("API Endpoint", "https://cloudflare-quic.com/b/")
