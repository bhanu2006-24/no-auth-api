...
st.set_page_config(page_title="Open Government, Slovakia", page_icon="🌐")

st.title("🌐 Open Government, Slovakia")
st.markdown("""
Slovakia Government Open Data

**URL:** [https://data.gov.sk/en/](https://data.gov.sk/en/)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.sk/en/")
