...
st.set_page_config(page_title="Genrenator", page_icon="🌐")

st.title("🌐 Genrenator")
st.markdown("""
Music genre generator

**URL:** [https://binaryjazz.us/genrenator-api/](https://binaryjazz.us/genrenator-api/)
""")
...
url = st.text_input("API Endpoint", "https://binaryjazz.us/genrenator-api/")
