...
st.set_page_config(page_title="Nexchange", page_icon="🌐")

st.title("🌐 Nexchange")
st.markdown("""
Automated cryptocurrency exchange service

**URL:** [https://nexchange2.docs.apiary.io/](https://nexchange2.docs.apiary.io/)
""")
...
url = st.text_input("API Endpoint", "https://nexchange2.docs.apiary.io/")
