...
st.title("🌐 DigitalOcean Status")
st.markdown("""
Status of all DigitalOcean services

**URL:** [https://status.digitalocean.com/api](https://status.digitalocean.com/api)
""")
...
url = st.text_input("API Endpoint", "https://status.digitalocean.com/api")
