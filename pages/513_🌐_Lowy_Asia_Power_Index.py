...
st.set_page_config(page_title="Lowy Asia Power Index", page_icon="🌐")

st.title("🌐 Lowy Asia Power Index")
st.markdown("""
Get measure resources and influence to rank the relative power of states in Asia

**URL:** [https://github.com/0x0is1/lowy-index-api-docs](https://github.com/0x0is1/lowy-index-api-docs)
""")
...
url = st.text_input("API Endpoint", "https://github.com/0x0is1/lowy-index-api-docs")
