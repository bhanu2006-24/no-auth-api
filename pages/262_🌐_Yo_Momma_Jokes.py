...
st.set_page_config(page_title="Yo Momma Jokes", page_icon="🌐")

st.title("🌐 Yo Momma Jokes")
st.markdown("""
REST API for Yo Momma Jokes

**URL:** [https://github.com/beanboi7/yomomma-apiv2](https://github.com/beanboi7/yomomma-apiv2)
""")
...
url = st.text_input("API Endpoint", "https://github.com/beanboi7/yomomma-apiv2")
