...
st.title("🌐 Lucifer Quotes")
st.markdown("""
Returns Lucifer quotes

**URL:** [https://github.com/shadowoff09/lucifer-quotes](https://github.com/shadowoff09/lucifer-quotes)
""")
...
url = st.text_input("API Endpoint", "https://github.com/shadowoff09/lucifer-quotes")
