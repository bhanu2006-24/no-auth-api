...
st.title("🌐 Cat Facts")
st.markdown("""
Explore the Cat Facts API.

**URL:** [https://cat-fact.herokuapp.com/facts](https://cat-fact.herokuapp.com/facts)
""")
...
url = st.text_input("API Endpoint", "https://cat-fact.herokuapp.com/facts")
