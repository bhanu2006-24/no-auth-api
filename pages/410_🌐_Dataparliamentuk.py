...
st.set_page_config(page_title="Data.parliament.uk", page_icon="🌐")

st.title("🌐 Data.parliament.uk")
st.markdown("""
Contains live datasets including information about petitions, bills, MP votes, attendance and more

**URL:** [https://explore.data.parliament.uk/?learnmore=Members](https://explore.data.parliament.uk/?learnmore=Members)
""")
...
url = st.text_input("API Endpoint", "https://explore.data.parliament.uk/?learnmore=Members")
