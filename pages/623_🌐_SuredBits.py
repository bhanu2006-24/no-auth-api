...
st.set_page_config(page_title="SuredBits", page_icon="🌐")

st.title("🌐 SuredBits")
st.markdown("""
Query sports data, including teams, players, games, scores and statistics

**URL:** [https://suredbits.com/api/](https://suredbits.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://suredbits.com/api/")
