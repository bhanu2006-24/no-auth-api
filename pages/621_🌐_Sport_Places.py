...
st.set_page_config(page_title="Sport Places", page_icon="🌐")

st.title("🌐 Sport Places")
st.markdown("""
Crowd-source sports places around the world

**URL:** [https://developers.decathlon.com/products/sport-places](https://developers.decathlon.com/products/sport-places)
""")
...
url = st.text_input("API Endpoint", "https://developers.decathlon.com/products/sport-places")
