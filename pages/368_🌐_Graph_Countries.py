...
st.set_page_config(page_title="Graph Countries", page_icon="🌐")

st.title("🌐 Graph Countries")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://github.com/lennertVanSever/graphcountries")
