...
st.set_page_config(page_title="Serialif Color", page_icon="🌐")

st.title("🌐 Serialif Color")
st.markdown("""
Color conversion, complementary, grayscale and contrasted text

**URL:** [https://color.serialif.com/](https://color.serialif.com/)
""")
...
url = st.text_input("API Endpoint", "https://color.serialif.com/")
