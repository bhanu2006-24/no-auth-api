...
st.set_page_config(page_title="Oddsmagnet", page_icon="🌐")

st.title("🌐 Oddsmagnet")
st.markdown("""
Odds history from multiple UK bookmakers

**URL:** [https://data.oddsmagnet.com](https://data.oddsmagnet.com)
""")
...
url = st.text_input("API Endpoint", "https://data.oddsmagnet.com")
