...
st.set_page_config(page_title="Open Government, New Zealand", page_icon="🌐")

st.title("🌐 Open Government, New Zealand")
st.markdown("""
New Zealand Government Open Data

**URL:** [https://www.data.govt.nz/](https://www.data.govt.nz/)
""")
...
url = st.text_input("API Endpoint", "https://www.data.govt.nz/")
