...
st.set_page_config(page_title="Transport for Czech Republic", page_icon="🌐")

st.title("🌐 Transport for Czech Republic")
st.markdown("""
Czech transport API

**URL:** [https://www.chaps.cz/eng/products/idos-internet](https://www.chaps.cz/eng/products/idos-internet)
""")
...
url = st.text_input("API Endpoint", "https://www.chaps.cz/eng/products/idos-internet")
