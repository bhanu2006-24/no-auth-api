...
st.set_page_config(page_title="Velib metropolis, Paris, France", page_icon="🌐")

st.title("🌐 Velib metropolis, Paris, France")
st.markdown("""
Velib Open Data API

**URL:** [https://www.velib-metropole.fr/donnees-open-data-gbfs-du-service-velib-metropole](https://www.velib-metropole.fr/donnees-open-data-gbfs-du-service-velib-metropole)
""")
...
url = st.text_input("API Endpoint", "https://www.velib-metropole.fr/donnees-open-data-gbfs-du-service-velib-metropole")
