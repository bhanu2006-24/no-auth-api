...
st.set_page_config(page_title="Spanish random words", page_icon="🌐")

st.title("🌐 Spanish random words")
st.markdown("""
Generate spanish words randomly

**URL:** [https://palabras-aleatorias-public-api.herokuapp.com](https://palabras-aleatorias-public-api.herokuapp.com)
""")
...
url = st.text_input("API Endpoint", "https://palabras-aleatorias-public-api.herokuapp.com")
