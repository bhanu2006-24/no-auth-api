...
st.set_page_config(page_title="ODWeather", page_icon="🌐")

st.title("🌐 ODWeather")
st.markdown("""
Weather and weather webcams

**URL:** [http://api.oceandrivers.com/static/docs.html](http://api.oceandrivers.com/static/docs.html)
""")
...
url = st.text_input("API Endpoint", "http://api.oceandrivers.com/static/docs.html")
