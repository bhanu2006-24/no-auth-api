...
st.set_page_config(page_title="Covid-19 India", page_icon="🌐")

st.title("🌐 Covid-19 India")
st.markdown("""
Covid 19 statistics state and district wise about cases, vaccinations, recovery within India

**URL:** [https://data.covid19india.org/](https://data.covid19india.org/)
""")
...
url = st.text_input("API Endpoint", "https://data.covid19india.org/")
