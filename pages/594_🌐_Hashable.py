...
st.set_page_config(page_title="Hashable", page_icon="🌐")

st.title("🌐 Hashable")
st.markdown("""
A REST API to access high level cryptographic functions and methods

**URL:** [https://hashable.space/pages/api/](https://hashable.space/pages/api/)
""")
...
url = st.text_input("API Endpoint", "https://hashable.space/pages/api/")
