...
st.set_page_config(page_title="ExtendsClass JSON Storage", page_icon="🌐")

st.title("🌐 ExtendsClass JSON Storage")
st.markdown("""
A simple JSON store API

**URL:** [https://extendsclass.com/json-storage.html](https://extendsclass.com/json-storage.html)
""")
...
url = st.text_input("API Endpoint", "https://extendsclass.com/json-storage.html")
