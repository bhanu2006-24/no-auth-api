...
st.set_page_config(page_title="IMDbOT", page_icon="🌐")

st.title("🌐 IMDbOT")
st.markdown("""
Unofficial IMDb Movie / Series Information

**URL:** [https://github.com/SpEcHiDe/IMDbOT](https://github.com/SpEcHiDe/IMDbOT)
""")
...
url = st.text_input("API Endpoint", "https://github.com/SpEcHiDe/IMDbOT")
