...
st.set_page_config(page_title="OpenSky Network", page_icon="🌐")

st.title("🌐 OpenSky Network")
st.markdown("""
Free real-time ADS-B aviation data

**URL:** [https://opensky-network.org/apidoc/index.html](https://opensky-network.org/apidoc/index.html)
""")
...
url = st.text_input("API Endpoint", "https://opensky-network.org/apidoc/index.html")
