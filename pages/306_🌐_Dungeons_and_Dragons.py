...
st.set_page_config(page_title="Dungeons and Dragons", page_icon="🌐")

st.title("🌐 Dungeons and Dragons")
st.markdown("""
Reference for 5th edition spells, classes, monsters, and more

**URL:** [https://www.dnd5eapi.co/docs/](https://www.dnd5eapi.co/docs/)
""")
...
url = st.text_input("API Endpoint", "https://www.dnd5eapi.co/docs/")
