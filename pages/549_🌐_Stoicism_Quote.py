...
st.set_page_config(page_title="Stoicism Quote", page_icon="🌐")

st.title("🌐 Stoicism Quote")
st.markdown("""
Quotes about Stoicism

**URL:** [https://github.com/tlcheah2/stoic-quote-lambda-public-api](https://github.com/tlcheah2/stoic-quote-lambda-public-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/tlcheah2/stoic-quote-lambda-public-api")
