...
st.set_page_config(page_title="QuickMocker", page_icon="🌐")

st.title("🌐 QuickMocker")
st.markdown("""
API mocking tool to generate contextual, fake or random data

**URL:** [https://quickmocker.com](https://quickmocker.com)
""")
...
url = st.text_input("API Endpoint", "https://quickmocker.com")
