...
st.set_page_config(page_title="Brazilian Vehicles and Prices", page_icon="🌐")

st.title("🌐 Brazilian Vehicles and Prices")
st.markdown("""
Vehicles information from Fundação Instituto de Pesquisas Econômicas - Fipe

**URL:** [https://deividfortuna.github.io/fipe/](https://deividfortuna.github.io/fipe/)
""")
...
url = st.text_input("API Endpoint", "https://deividfortuna.github.io/fipe/")
