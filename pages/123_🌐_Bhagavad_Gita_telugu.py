...
st.set_page_config(page_title="Bhagavad Gita telugu", page_icon="🌐")

st.title("🌐 Bhagavad Gita telugu")
st.markdown("""
Bhagavad Gita API in telugu and odia languages

**URL:** [https://gita-api.vercel.app](https://gita-api.vercel.app)
""")
...
url = st.text_input("API Endpoint", "https://gita-api.vercel.app")
