...
st.set_page_config(page_title="Chuck Norris Database", page_icon="🌐")

st.title("🌐 Chuck Norris Database")
st.markdown("""
Jokes

**URL:** [http://www.icndb.com/api/](http://www.icndb.com/api/)
""")
...
url = st.text_input("API Endpoint", "http://www.icndb.com/api/")
