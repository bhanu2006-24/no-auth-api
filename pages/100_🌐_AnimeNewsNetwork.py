...
**URL:** [https://www.animenewsnetwork.com/encyclopedia/api.php](https://www.animenewsnetwork.com/encyclopedia/api.php)
""")
...
url = st.text_input("API Endpoint", "https://www.animenewsnetwork.com/encyclopedia/api.php")
