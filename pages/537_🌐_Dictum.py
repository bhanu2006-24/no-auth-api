...
st.set_page_config(page_title="Dictum", page_icon="🌐")

st.title("🌐 Dictum")
st.markdown("""
API to get access to the collection of the most inspiring expressions of mankind

**URL:** [https://github.com/fisenkodv/dictum](https://github.com/fisenkodv/dictum)
""")
...
url = st.text_input("API Endpoint", "https://github.com/fisenkodv/dictum")
