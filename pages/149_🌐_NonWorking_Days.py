...
st.set_page_config(page_title="Non-Working Days", page_icon="🌐")

st.title("🌐 Non-Working Days")
st.markdown("""
Database of ICS files for non working days

**URL:** [https://github.com/gadael/icsdb](https://github.com/gadael/icsdb)
""")
...
url = st.text_input("API Endpoint", "https://github.com/gadael/icsdb")
