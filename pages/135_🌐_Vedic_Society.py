...
st.set_page_config(page_title="Vedic Society", page_icon="🌐")

st.title("🌐 Vedic Society")
st.markdown("""
Descriptions of all nouns (names, places, animals, things) from vedic literature

**URL:** [https://aninditabasu.github.io/indica/html/vs.html](https://aninditabasu.github.io/indica/html/vs.html)
""")
...
url = st.text_input("API Endpoint", "https://aninditabasu.github.io/indica/html/vs.html")
