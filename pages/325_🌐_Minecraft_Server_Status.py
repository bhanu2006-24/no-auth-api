...
st.set_page_config(page_title="Minecraft Server Status", page_icon="🌐")

st.title("🌐 Minecraft Server Status")
st.markdown("""
API to get Information about a Minecraft Server

**URL:** [https://api.mcsrvstat.us](https://api.mcsrvstat.us)
""")
...
url = st.text_input("API Endpoint", "https://api.mcsrvstat.us")
