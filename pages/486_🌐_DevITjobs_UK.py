...
st.set_page_config(page_title="DevITjobs UK", page_icon="🌐")

st.title("🌐 DevITjobs UK")
st.markdown("""
Jobs with GraphQL

**URL:** [https://devitjobs.uk/job_feed.xml](https://devitjobs.uk/job_feed.xml)
""")
...
url = st.text_input("API Endpoint", "https://devitjobs.uk/job_feed.xml")
