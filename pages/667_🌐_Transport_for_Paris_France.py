...
st.set_page_config(page_title="Transport for Paris, France", page_icon="🌐")

st.title("🌐 Transport for Paris, France")
st.markdown("""
RATP Open Data API

**URL:** [http://data.ratp.fr/api/v1/console/datasets/1.0/search/](http://data.ratp.fr/api/v1/console/datasets/1.0/search/)
""")
...
url = st.text_input("API Endpoint", "http://data.ratp.fr/api/v1/console/datasets/1.0/search/")
