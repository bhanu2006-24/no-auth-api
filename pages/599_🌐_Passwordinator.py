...
st.set_page_config(page_title="Passwordinator", page_icon="🌐")

st.title("🌐 Passwordinator")
st.markdown("""
Generate random passwords of varying complexities

**URL:** [https://github.com/fawazsullia/password-generator/](https://github.com/fawazsullia/password-generator/)
""")
...
url = st.text_input("API Endpoint", "https://github.com/fawazsullia/password-generator/")
