...
st.set_page_config(page_title="weather-api", page_icon="🌐")

st.title("🌐 weather-api")
st.markdown("""
A RESTful free API to check the weather

**URL:** [https://github.com/robertoduessmann/weather-api](https://github.com/robertoduessmann/weather-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/robertoduessmann/weather-api")
