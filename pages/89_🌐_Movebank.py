...
st.title("🌐 Movebank")
st.markdown("""
Explore the Movebank API.

**URL:** [https://www.movebank.org/movebank/service/direct-read](https://www.movebank.org/movebank/service/direct-read)
""")
...
url = st.text_input("API Endpoint", "https://www.movebank.org/movebank/service/direct-read")
