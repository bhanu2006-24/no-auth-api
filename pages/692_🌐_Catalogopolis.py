...
st.set_page_config(page_title="Catalogopolis", page_icon="🌐")

st.title("🌐 Catalogopolis")
st.markdown("""
Doctor Who API

**URL:** [https://api.catalogopolis.xyz/docs/](https://api.catalogopolis.xyz/docs/)
""")
...
url = st.text_input("API Endpoint", "https://api.catalogopolis.xyz/docs/")
