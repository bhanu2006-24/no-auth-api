...
st.set_page_config(page_title="isEven (humor)", page_icon="🌐")

st.title("🌐 isEven (humor)")
st.markdown("""
Check if a number is even

**URL:** [https://isevenapi.xyz/](https://isevenapi.xyz/)
""")
...
url = st.text_input("API Endpoint", "https://isevenapi.xyz/")
