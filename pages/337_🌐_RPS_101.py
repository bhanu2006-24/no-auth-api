...
st.set_page_config(page_title="RPS 101", page_icon="🌐")

st.title("🌐 RPS 101")
st.markdown("""
Rock, Paper, Scissors with 101 objects

**URL:** [https://rps101.pythonanywhere.com/api](https://rps101.pythonanywhere.com/api)
""")
...
url = st.text_input("API Endpoint", "https://rps101.pythonanywhere.com/api")
