...
st.set_page_config(page_title="US Presidential Election Data by TogaTech", page_icon="🌐")

st.title("🌐 US Presidential Election Data by TogaTech")
st.markdown("""
Basic candidate data and live electoral vote counts for top two parties in US presidential election

**URL:** [https://uselection.togatech.org/api/](https://uselection.togatech.org/api/)
""")
...
url = st.text_input("API Endpoint", "https://uselection.togatech.org/api/")
