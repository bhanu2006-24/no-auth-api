...
st.set_page_config(page_title="City, Gdynia", page_icon="🌐")

st.title("🌐 City, Gdynia")
st.markdown("""
Gdynia (PL) City Open Data

**URL:** [http://otwartedane.gdynia.pl/en/api_doc.html](http://otwartedane.gdynia.pl/en/api_doc.html)
""")
...
url = st.text_input("API Endpoint", "http://otwartedane.gdynia.pl/en/api_doc.html")
