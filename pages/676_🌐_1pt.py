...
st.set_page_config(page_title="1pt", page_icon="🌐")

st.title("🌐 1pt")
st.markdown("""
A simple URL shortener

**URL:** [https://github.com/1pt-co/api/blob/main/README.md](https://github.com/1pt-co/api/blob/main/README.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/1pt-co/api/blob/main/README.md")
