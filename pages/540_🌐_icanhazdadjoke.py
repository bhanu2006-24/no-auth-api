...
st.set_page_config(page_title="icanhazdadjoke", page_icon="🌐")

st.title("🌐 icanhazdadjoke")
st.markdown("""
The largest selection of dad jokes on the internet

**URL:** [https://icanhazdadjoke.com/api](https://icanhazdadjoke.com/api)
""")
...
url = st.text_input("API Endpoint", "https://icanhazdadjoke.com/api")
