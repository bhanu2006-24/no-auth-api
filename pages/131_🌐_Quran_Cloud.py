...
st.set_page_config(page_title="Quran Cloud", page_icon="🌐")

st.title("🌐 Quran Cloud")
st.markdown("""
A RESTful Quran API to retrieve an Ayah, Surah, Juz or the entire Holy Quran

**URL:** [https://alquran.cloud/api](https://alquran.cloud/api)
""")
...
url = st.text_input("API Endpoint", "https://alquran.cloud/api")
