...
st.set_page_config(page_title="City, Lviv", page_icon="🌐")

st.title("🌐 City, Lviv")
st.markdown("""
Lviv(UA) City Open Data

**URL:** [https://opendata.city-adm.lviv.ua/](https://opendata.city-adm.lviv.ua/)
""")
...
url = st.text_input("API Endpoint", "https://opendata.city-adm.lviv.ua/")
