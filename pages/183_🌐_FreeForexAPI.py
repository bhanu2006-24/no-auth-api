...
st.title("🌐 FreeForexAPI")
st.markdown("""
Real-time foreign exchange rates for major currency pairs

**URL:** [https://freeforexapi.com/Home/Api](https://freeforexapi.com/Home/Api)
""")
...
url = st.text_input("API Endpoint", "https://freeforexapi.com/Home/Api")
