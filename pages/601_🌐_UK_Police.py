...
st.set_page_config(page_title="UK Police", page_icon="🌐")

st.title("🌐 UK Police")
st.markdown("""
UK Police data

**URL:** [https://data.police.uk/docs/](https://data.police.uk/docs/)
""")
...
url = st.text_input("API Endpoint", "https://data.police.uk/docs/")
