...
st.set_page_config(page_title="Toolcarton", page_icon="🌐")

st.title("🌐 Toolcarton")
st.markdown("""
Generate random testimonial data

**URL:** [https://testimonialapi.toolcarton.com/](https://testimonialapi.toolcarton.com/)
""")
...
url = st.text_input("API Endpoint", "https://testimonialapi.toolcarton.com/")
