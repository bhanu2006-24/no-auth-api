...
st.set_page_config(page_title="Bandsintown", page_icon="🌐")

st.title("🌐 Bandsintown")
st.markdown("""
Music Events

**URL:** [https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0)
""")
...
url = st.text_input("API Endpoint", "https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0")
