...
st.set_page_config(page_title="Coronavirus in the UK", page_icon="🌐")

st.title("🌐 Coronavirus in the UK")
st.markdown("""
UK Government coronavirus data, including deaths and cases by region

**URL:** [https://coronavirus.data.gov.uk/details/developers-guide](https://coronavirus.data.gov.uk/details/developers-guide)
""")
...
url = st.text_input("API Endpoint", "https://coronavirus.data.gov.uk/details/developers-guide")
