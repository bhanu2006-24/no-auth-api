...
st.set_page_config(page_title="HTTP2.Pro", page_icon="🌐")

st.title("🌐 HTTP2.Pro")
st.markdown("""
Test endpoints for client and server HTTP/2 protocol support

**URL:** [https://http2.pro/doc/api](https://http2.pro/doc/api)
""")
...
url = st.text_input("API Endpoint", "https://http2.pro/doc/api")
