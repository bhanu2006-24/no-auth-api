...
st.set_page_config(page_title="Phone Specification", page_icon="🌐")

st.title("🌐 Phone Specification")
st.markdown("""
Rest Api for Phone specifications

**URL:** [https://github.com/azharimm/phone-specs-api](https://github.com/azharimm/phone-specs-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/azharimm/phone-specs-api")
