...
st.set_page_config(page_title="PostalPinCode", page_icon="🌐")

st.title("🌐 PostalPinCode")
st.markdown("""
API for getting Pincode details in India

**URL:** [http://www.postalpincode.in/Api-Details](http://www.postalpincode.in/Api-Details)
""")
...
url = st.text_input("API Endpoint", "http://www.postalpincode.in/Api-Details")
