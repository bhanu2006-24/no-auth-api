...
st.set_page_config(page_title="National Bank of Poland", page_icon="🌐")

st.title("🌐 National Bank of Poland")
st.markdown("""
A collection of currency exchange rates (data in XML and JSON)

**URL:** [http://api.nbp.pl/en.html](http://api.nbp.pl/en.html)
""")
...
url = st.text_input("API Endpoint", "http://api.nbp.pl/en.html")
