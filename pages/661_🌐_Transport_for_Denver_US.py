...
st.set_page_config(page_title="Transport for Denver, US", page_icon="🌐")

st.title("🌐 Transport for Denver, US")
st.markdown("""
RTD

**URL:** [http://www.rtd-denver.com/gtfs-developer-guide.shtml](http://www.rtd-denver.com/gtfs-developer-guide.shtml)
""")
...
url = st.text_input("API Endpoint", "http://www.rtd-denver.com/gtfs-developer-guide.shtml")
