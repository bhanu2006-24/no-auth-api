...
st.set_page_config(page_title="Open Skills", page_icon="🌐")

st.title("🌐 Open Skills")
st.markdown("""
Job titles, skills and related jobs data

**URL:** [https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview](https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview)
""")
...
url = st.text_input("API Endpoint", "https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview")
