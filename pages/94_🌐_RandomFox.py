...
st.set_page_config(page_title="RandomFox", page_icon="🌐")

st.title("🌐 RandomFox")
st.markdown("""
Random pictures of foxes

**URL:** [https://randomfox.ca/floof/](https://randomfox.ca/floof/)
""")
...
url = st.text_input("API Endpoint", "https://randomfox.ca/floof/")
