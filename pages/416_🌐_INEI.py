...
st.set_page_config(page_title="INEI", page_icon="🌐")

st.title("🌐 INEI")
st.markdown("""
Peruvian Statistical Government Open Data

**URL:** [http://iinei.inei.gob.pe/microdatos/](http://iinei.inei.gob.pe/microdatos/)
""")
...
url = st.text_input("API Endpoint", "http://iinei.inei.gob.pe/microdatos/")
