...
st.set_page_config(page_title="apilayer screenshotlayer", page_icon="🌐")

st.title("🌐 apilayer screenshotlayer")
st.markdown("""
URL 2 Image
...
url = st.text_input("API Endpoint", "https://screenshotlayer.com")
