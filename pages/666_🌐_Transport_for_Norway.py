...
st.set_page_config(page_title="Transport for Norway", page_icon="🌐")

st.title("🌐 Transport for Norway")
st.markdown("""
Transport APIs and dataset for Norway

**URL:** [https://developer.entur.org/](https://developer.entur.org/)
""")
...
url = st.text_input("API Endpoint", "https://developer.entur.org/")
