...
st.set_page_config(page_title="EPA", page_icon="🌐")

st.title("🌐 EPA")
st.markdown("""
Web services and data sets from the US Environmental Protection Agency

**URL:** [https://www.epa.gov/developers/data-data-products#apis](https://www.epa.gov/developers/data-data-products#apis)
""")
...
url = st.text_input("API Endpoint", "https://www.epa.gov/developers/data-data-products#apis")
