...
st.set_page_config(page_title="4chan", page_icon="🌐")

st.title("🌐 4chan")
st.markdown("""
Simple image-based bulletin board dedicated to a variety of topics

**URL:** [https://github.com/4chan/4chan-API](https://github.com/4chan/4chan-API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/4chan/4chan-API")
