...
st.set_page_config(page_title="Hyrule Compendium", page_icon="🌐")

st.title("🌐 Hyrule Compendium")
st.markdown("""
Data on all interactive items from The Legend of Zelda: BOTW

**URL:** [https://github.com/gadhagod/Hyrule-Compendium-API](https://github.com/gadhagod/Hyrule-Compendium-API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/gadhagod/Hyrule-Compendium-API")
