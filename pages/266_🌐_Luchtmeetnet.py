...
st.set_page_config(page_title="Luchtmeetnet", page_icon="🌐")

st.title("🌐 Luchtmeetnet")
st.markdown("""
Predicted and actual air quality components for The Netherlands (RIVM)

**URL:** [https://api-docs.luchtmeetnet.nl/](https://api-docs.luchtmeetnet.nl/)
""")
...
url = st.text_input("API Endpoint", "https://api-docs.luchtmeetnet.nl/")
