...
st.set_page_config(page_title="airportsapi", page_icon="🌐")

st.title("🌐 airportsapi")
st.markdown("""
Get name and website-URL for airports by ICAO code

**URL:** [https://airport-web.appspot.com/api/docs/](https://airport-web.appspot.com/api/docs/)
""")
...
url = st.text_input("API Endpoint", "https://airport-web.appspot.com/api/docs/")
