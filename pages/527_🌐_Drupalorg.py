...
st.set_page_config(page_title="Drupal.org", page_icon="🌐")

st.title("🌐 Drupal.org")
st.markdown("""
Drupal.org

**URL:** [https://www.drupal.org/drupalorg/docs/api](https://www.drupal.org/drupalorg/docs/api)
""")
...
url = st.text_input("API Endpoint", "https://www.drupal.org/drupalorg/docs/api")
