...
st.set_page_config(page_title="Magic The Gathering", page_icon="🌐")

st.title("🌐 Magic The Gathering")
st.markdown("""
Magic The Gathering Game Information

**URL:** [http://magicthegathering.io/](http://magicthegathering.io/)
""")
...
url = st.text_input("API Endpoint", "http://magicthegathering.io/")
