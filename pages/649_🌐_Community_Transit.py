...
st.set_page_config(page_title="Community Transit", page_icon="🌐")

st.title("🌐 Community Transit")
st.markdown("""
Transitland API

**URL:** [https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints](https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints)
""")
...
url = st.text_input("API Endpoint", "https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints")
