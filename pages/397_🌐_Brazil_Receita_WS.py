...
st.set_page_config(page_title="Brazil Receita WS", page_icon="🌐")

st.title("🌐 Brazil Receita WS")
st.markdown("""
Consult companies by CNPJ for Brazilian companies

**URL:** [https://www.receitaws.com.br/](https://www.receitaws.com.br/)
""")
...
url = st.text_input("API Endpoint", "https://www.receitaws.com.br/")
