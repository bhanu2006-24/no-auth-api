...
st.set_page_config(page_title="Short Link", page_icon="🌐")

st.title("🌐 Short Link")
st.markdown("""
Short URLs support so many domains

**URL:** [https://github.com/FayasNoushad/Short-Link-API](https://github.com/FayasNoushad/Short-Link-API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/FayasNoushad/Short-Link-API")
