...
st.set_page_config(page_title="Open Government, ACT", page_icon="🌐")

st.title("🌐 Open Government, ACT")
st.markdown("""
Australian Capital Territory Open Data

**URL:** [https://www.data.act.gov.au/](https://www.data.act.gov.au/)
""")
...
url = st.text_input("API Endpoint", "https://www.data.act.gov.au/")
