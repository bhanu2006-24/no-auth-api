...
st.set_page_config(page_title="NPPES", page_icon="🌐")

st.title("🌐 NPPES")
st.markdown("""
National Plan & Provider Enumeration System, info on healthcare providers registered in US

**URL:** [https://npiregistry.cms.hhs.gov/registry/help-api](https://npiregistry.cms.hhs.gov/registry/help-api)
""")
...
url = st.text_input("API Endpoint", "https://npiregistry.cms.hhs.gov/registry/help-api")
