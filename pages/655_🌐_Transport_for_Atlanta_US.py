...
st.set_page_config(page_title="Transport for Atlanta, US", page_icon="🌐")

st.title("🌐 Transport for Atlanta, US")
st.markdown("""
Marta

**URL:** [http://www.itsmarta.com/app-developer-resources.aspx](http://www.itsmarta.com/app-developer-resources.aspx)
""")
...
url = st.text_input("API Endpoint", "http://www.itsmarta.com/app-developer-resources.aspx")
