...
st.set_page_config(page_title="Football (Soccer) Videos", page_icon="🌐")

st.title("🌐 Football (Soccer) Videos")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://www.scorebat.com/video-api/")
