...
st.set_page_config(page_title="Breaking Bad Quotes", page_icon="🌐")

st.title("🌐 Breaking Bad Quotes")
st.markdown("""
Some Breaking Bad quotes

**URL:** [https://github.com/shevabam/breaking-bad-quotes](https://github.com/shevabam/breaking-bad-quotes)
""")
...
url = st.text_input("API Endpoint", "https://github.com/shevabam/breaking-bad-quotes")
