...
st.set_page_config(page_title="balldontlie", page_icon="🌐")

st.title("🌐 balldontlie")
st.markdown("""
Balldontlie provides access to stats data from the NBA

**URL:** [https://www.balldontlie.io](https://www.balldontlie.io)
""")
...
url = st.text_input("API Endpoint", "https://www.balldontlie.io")
