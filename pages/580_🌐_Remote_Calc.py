...
st.set_page_config(page_title="Remote Calc", page_icon="🌐")

st.title("🌐 Remote Calc")
st.markdown("""
Decodes base64 encoding and parses it to return a solution to the calculation in JSON

**URL:** [https://github.com/elizabethadegbaju/remotecalc](https://github.com/elizabethadegbaju/remotecalc)
""")
...
url = st.text_input("API Endpoint", "https://github.com/elizabethadegbaju/remotecalc")
