...
st.set_page_config(page_title="Countly", page_icon="🌐")

st.title("🌐 Countly")
st.markdown("""
Countly web analytics

**URL:** [https://api.count.ly/reference](https://api.count.ly/reference)
""")
...
url = st.text_input("API Endpoint", "https://api.count.ly/reference")
