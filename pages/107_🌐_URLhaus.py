...
st.set_page_config(page_title="URLhaus", page_icon="🌐")

st.title("🌐 URLhaus")
st.markdown("""
Bulk queries and Download Malware Samples

**URL:** [https://urlhaus-api.abuse.ch/](https://urlhaus-api.abuse.ch/)
""")
...
url = st.text_input("API Endpoint", "https://urlhaus-api.abuse.ch/")
