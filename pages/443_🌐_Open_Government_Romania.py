...
st.set_page_config(page_title="Open Government, Romania", page_icon="🌐")

st.title("🌐 Open Government, Romania")
st.markdown("""
Romania Government Open Data

**URL:** [http://data.gov.ro/](http://data.gov.ro/)
""")
...
url = st.text_input("API Endpoint", "http://data.gov.ro/")
