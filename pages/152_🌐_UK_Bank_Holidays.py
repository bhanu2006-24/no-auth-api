...
st.title("🌐 UK Bank Holidays")
st.markdown("""
Bank holidays in England and Wales, Scotland and Northern Ireland

**URL:** [https://www.gov.uk/bank-holidays.json](https://www.gov.uk/bank-holidays.json)
""")
...
url = st.text_input("API Endpoint", "https://www.gov.uk/bank-holidays.json")
