...
st.set_page_config(page_title="Chess.com", page_icon="🌐")

st.title("🌐 Chess.com")
st.markdown("""
Chess.com read-only REST API

**URL:** [https://www.chess.com/news/view/published-data-api](https://www.chess.com/news/view/published-data-api)
""")
...
url = st.text_input("API Endpoint", "https://www.chess.com/news/view/published-data-api")
