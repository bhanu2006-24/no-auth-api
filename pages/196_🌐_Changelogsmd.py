...
st.set_page_config(page_title="Changelogs.md", page_icon="🌐")

st.title("🌐 Changelogs.md")
st.markdown("""
Structured changelog metadata from open source projects

**URL:** [https://changelogs.md](https://changelogs.md)
""")
...
url = st.text_input("API Endpoint", "https://changelogs.md")
