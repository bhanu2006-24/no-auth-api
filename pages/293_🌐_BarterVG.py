...
st.set_page_config(page_title="Barter.VG", page_icon="🌐")

st.title("🌐 Barter.VG")
st.markdown("""
Provides information about Game, DLC, Bundles, Giveaways, Trading

**URL:** [https://github.com/bartervg/barter.vg/wiki](https://github.com/bartervg/barter.vg/wiki)
""")
...
url = st.text_input("API Endpoint", "https://github.com/bartervg/barter.vg/wiki")
