...
st.set_page_config(page_title="French Address Search", page_icon="🌐")

st.title("🌐 French Address Search")
st.markdown("""
Address search via the French Government

**URL:** [https://geo.api.gouv.fr/adresse](https://geo.api.gouv.fr/adresse)
""")
...
url = st.text_input("API Endpoint", "https://geo.api.gouv.fr/adresse")
