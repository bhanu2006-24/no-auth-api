...
st.set_page_config(page_title="Census.gov", page_icon="🌐")

st.title("🌐 Census.gov")
st.markdown("""
The US Census Bureau provides various APIs and data sets on demographics and businesses

**URL:** [https://www.census.gov/data/developers/data-sets.html](https://www.census.gov/data/developers/data-sets.html)
""")
...
url = st.text_input("API Endpoint", "https://www.census.gov/data/developers/data-sets.html")
