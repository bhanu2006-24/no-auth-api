...
st.set_page_config(page_title="Covid-19 Philippines", page_icon="🌐")

st.title("🌐 Covid-19 Philippines")
st.markdown("""
Unofficial Covid-19 Web API for Philippines from data collected by DOH

**URL:** [https://github.com/Simperfy/Covid-19-API-Philippines-DOH](https://github.com/Simperfy/Covid-19-API-Philippines-DOH)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Simperfy/Covid-19-API-Philippines-DOH")
