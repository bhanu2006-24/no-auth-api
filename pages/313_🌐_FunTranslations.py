...
st.set_page_config(page_title="FunTranslations", page_icon="🌐")

st.title("🌐 FunTranslations")
st.markdown("""
Translate Text into funny languages

**URL:** [https://api.funtranslations.com/](https://api.funtranslations.com/)
""")
...
url = st.text_input("API Endpoint", "https://api.funtranslations.com/")
