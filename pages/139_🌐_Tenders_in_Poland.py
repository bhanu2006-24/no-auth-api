...
st.set_page_config(page_title="Tenders in Poland", page_icon="🌐")

st.title("🌐 Tenders in Poland")
st.markdown("""
Get data for procurements in Poland in JSON format

**URL:** [https://tenders.guru/pl/api](https://tenders.guru/pl/api)
""")
...
url = st.text_input("API Endpoint", "https://tenders.guru/pl/api")
