...
st.set_page_config(page_title="Minor Planet Center", page_icon="🌐")

st.title("🌐 Minor Planet Center")
st.markdown("""
Asterank.com Information

**URL:** [http://www.asterank.com/mpc](http://www.asterank.com/mpc)
""")
...
url = st.text_input("API Endpoint", "http://www.asterank.com/mpc")
