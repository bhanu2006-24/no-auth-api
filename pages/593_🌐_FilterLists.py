...
st.set_page_config(page_title="FilterLists", page_icon="🌐")

st.title("🌐 FilterLists")
st.markdown("""
Lists of filters for adblockers and firewalls

**URL:** [https://filterlists.com](https://filterlists.com)
""")
...
url = st.text_input("API Endpoint", "https://filterlists.com")
