...
st.set_page_config(page_title="LAPIS", page_icon="🌐")

st.title("🌐 LAPIS")
st.markdown("""
SARS-CoV-2 genomic sequences from public sources

**URL:** [https://cov-spectrum.ethz.ch/public](https://cov-spectrum.ethz.ch/public)
""")
...
url = st.text_input("API Endpoint", "https://cov-spectrum.ethz.ch/public")
