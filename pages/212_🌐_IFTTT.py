...
st.set_page_config(page_title="IFTTT", page_icon="🌐")

st.title("🌐 IFTTT")
st.markdown("""
IFTTT Connect API

**URL:** [https://platform.ifttt.com/docs/connect_api](https://platform.ifttt.com/docs/connect_api)
""")
...
url = st.text_input("API Endpoint", "https://platform.ifttt.com/docs/connect_api")
