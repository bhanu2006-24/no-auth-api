...
st.set_page_config(page_title="City, New York Open Data", page_icon="🌐")

st.title("🌐 City, New York Open Data")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://opendata.cityofnewyork.us/")
