...
st.set_page_config(page_title="Catch The Show", page_icon="🌐")

st.title("🌐 Catch The Show")
st.markdown("""
REST API for next-episode.net

**URL:** [https://catchtheshow.herokuapp.com/api/documentation](https://catchtheshow.herokuapp.com/api/documentation)
""")
...
url = st.text_input("API Endpoint", "https://catchtheshow.herokuapp.com/api/documentation")
