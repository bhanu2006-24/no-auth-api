...
st.set_page_config(page_title="GitHub Contribution Chart Generator", page_icon="🌐")

st.title("🌐 GitHub Contribution Chart Generator")
st.markdown("""
Create an image of your GitHub contributions

**URL:** [https://github-contributions.vercel.app](https://github-contributions.vercel.app)
""")
...
url = st.text_input("API Endpoint", "https://github-contributions.vercel.app")
