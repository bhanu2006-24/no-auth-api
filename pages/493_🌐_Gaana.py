...
st.set_page_config(page_title="Gaana", page_icon="🌐")

st.title("🌐 Gaana")
st.markdown("""
API to retrieve song information from Gaana

**URL:** [https://github.com/cyberboysumanjay/GaanaAPI](https://github.com/cyberboysumanjay/GaanaAPI)
""")
...
url = st.text_input("API Endpoint", "https://github.com/cyberboysumanjay/GaanaAPI")
