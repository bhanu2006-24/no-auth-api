...
st.set_page_config(page_title="Open Government, Peru", page_icon="🌐")

st.title("🌐 Open Government, Peru")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://www.datosabiertos.gob.pe/")
