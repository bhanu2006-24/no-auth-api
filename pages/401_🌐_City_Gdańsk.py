...
st.set_page_config(page_title="City, Gdańsk", page_icon="🌐")

st.title("🌐 City, Gdańsk")
st.markdown("""
Gdańsk (PL) City Open Data

**URL:** [https://ckan.multimediagdansk.pl/en](https://ckan.multimediagdansk.pl/en)
""")
...
url = st.text_input("API Endpoint", "https://ckan.multimediagdansk.pl/en")
