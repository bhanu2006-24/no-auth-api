...
st.set_page_config(page_title="Transport for Switzerland", page_icon="🌐")

st.title("🌐 Transport for Switzerland")
st.markdown("""
Swiss public transport API

**URL:** [https://transport.opendata.ch/](https://transport.opendata.ch/)
""")
...
url = st.text_input("API Endpoint", "https://transport.opendata.ch/")
