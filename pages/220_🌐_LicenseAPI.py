...
st.set_page_config(page_title="License-API", page_icon="🌐")

st.title("🌐 License-API")
st.markdown("""
Unofficial REST API for choosealicense.com

**URL:** [https://github.com/cmccandless/license-api/blob/master/README.md](https://github.com/cmccandless/license-api/blob/master/README.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/cmccandless/license-api/blob/master/README.md")
