...
st.set_page_config(page_title="Chinese Character Web", page_icon="🌐")

st.title("🌐 Chinese Character Web")
st.markdown("""
Chinese character definitions and pronunciations

**URL:** [http://ccdb.hemiola.com/](http://ccdb.hemiola.com/)
""")
...
url = st.text_input("API Endpoint", "http://ccdb.hemiola.com/")
