...
st.set_page_config(page_title="DomainDb Info", page_icon="🌐")

st.title("🌐 DomainDb Info")
st.markdown("""
Domain name search to find all domains containing particular words/phrases/etc

**URL:** [https://api.domainsdb.info/](https://api.domainsdb.info/)
""")
...
url = st.text_input("API Endpoint", "https://api.domainsdb.info/")
