...
st.set_page_config(page_title="Vector Express v2.0", page_icon="🌐")

st.title("🌐 Vector Express v2.0")
st.markdown("""
Free vector file converting API

**URL:** [https://vector.express](https://vector.express)
""")
...
url = st.text_input("API Endpoint", "https://vector.express")
