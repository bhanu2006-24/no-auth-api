...
st.set_page_config(page_title="Quran", page_icon="🌐")

st.title("🌐 Quran")
st.markdown("""
RESTful Quran API with multiple languages

**URL:** [https://quran.api-docs.io/](https://quran.api-docs.io/)
""")
...
url = st.text_input("API Endpoint", "https://quran.api-docs.io/")
