...
st.set_page_config(page_title="quoteclear", page_icon="🌐")

st.title("🌐 quoteclear")
st.markdown("""
Ever-growing list of James Clear quotes from the 3-2-1 Newsletter

**URL:** [https://quoteclear.web.app/](https://quoteclear.web.app/)
""")
...
url = st.text_input("API Endpoint", "https://quoteclear.web.app/")
