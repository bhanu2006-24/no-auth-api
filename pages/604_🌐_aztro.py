...
st.set_page_config(page_title="aztro", page_icon="🌐")

st.title("🌐 aztro")
st.markdown("""
Daily horoscope info for yesterday, today, and tomorrow

**URL:** [https://aztro.sameerkumar.website/](https://aztro.sameerkumar.website/)
""")
...
url = st.text_input("API Endpoint", "https://aztro.sameerkumar.website/")
