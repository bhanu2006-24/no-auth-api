...
st.set_page_config(page_title="Open Government, Netherlands", page_icon="🌐")

st.title("🌐 Open Government, Netherlands")
st.markdown("""
Netherlands Government Open Data

**URL:** [https://data.overheid.nl/en/ondersteuning/data-publiceren/api](https://data.overheid.nl/en/ondersteuning/data-publiceren/api)
""")
...
url = st.text_input("API Endpoint", "https://data.overheid.nl/en/ondersteuning/data-publiceren/api")
