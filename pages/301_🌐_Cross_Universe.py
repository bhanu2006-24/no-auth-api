...
st.set_page_config(page_title="Cross Universe", page_icon="🌐")

st.title("🌐 Cross Universe")
st.markdown("""
Cross Universe Card Data

**URL:** [https://crossuniverse.psychpsyo.com/apiDocs.html](https://crossuniverse.psychpsyo.com/apiDocs.html)
""")
...
url = st.text_input("API Endpoint", "https://crossuniverse.psychpsyo.com/apiDocs.html")
