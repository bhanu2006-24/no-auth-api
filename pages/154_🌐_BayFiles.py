...
st.set_page_config(page_title="BayFiles", page_icon="🌐")

st.title("🌐 BayFiles")
st.markdown("""
Upload and share your files

**URL:** [https://bayfiles.com/docs/api](https://bayfiles.com/docs/api)
""")
...
url = st.text_input("API Endpoint", "https://bayfiles.com/docs/api")
