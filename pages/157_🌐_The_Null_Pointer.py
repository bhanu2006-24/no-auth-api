...
st.set_page_config(page_title="The Null Pointer", page_icon="🌐")

st.title("🌐 The Null Pointer")
st.markdown("""
No-bullshit file hosting and URL shortening service

**URL:** [https://0x0.st](https://0x0.st)
""")
...
url = st.text_input("API Endpoint", "https://0x0.st")
