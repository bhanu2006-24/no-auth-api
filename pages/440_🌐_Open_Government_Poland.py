...
st.set_page_config(page_title="Open Government, Poland", page_icon="🌐")

st.title("🌐 Open Government, Poland")
st.markdown("""
Poland Government Open Data

**URL:** [https://dane.gov.pl/en](https://dane.gov.pl/en)
""")
...
url = st.text_input("API Endpoint", "https://dane.gov.pl/en")
