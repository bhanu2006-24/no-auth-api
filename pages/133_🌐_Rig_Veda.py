...
st.set_page_config(page_title="Rig Veda", page_icon="🌐")

st.title("🌐 Rig Veda")
st.markdown("""
Gods and poets, their categories, and the verse meters, with the mandal and sukta number

**URL:** [https://aninditabasu.github.io/indica/html/rv.html](https://aninditabasu.github.io/indica/html/rv.html)
""")
...
url = st.text_input("API Endpoint", "https://aninditabasu.github.io/indica/html/rv.html")
