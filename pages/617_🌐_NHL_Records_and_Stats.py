...
st.set_page_config(page_title="NHL Records and Stats", page_icon="🌐")

st.title("🌐 NHL Records and Stats")
st.markdown("""
NHL historical data and statistics

**URL:** [https://gitlab.com/dword4/nhlapi](https://gitlab.com/dword4/nhlapi)
""")
...
url = st.text_input("API Endpoint", "https://gitlab.com/dword4/nhlapi")
