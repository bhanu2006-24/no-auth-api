...
st.set_page_config(page_title="geoPlugin", page_icon="🌐")

st.title("🌐 geoPlugin")
st.markdown("""
IP geolocation and currency conversion

**URL:** [https://www.geoplugin.com](https://www.geoplugin.com)
""")
...
url = st.text_input("API Endpoint", "https://www.geoplugin.com")
