...
st.set_page_config(page_title="Open Government, Ireland", page_icon="🌐")

st.title("🌐 Open Government, Ireland")
st.markdown("""
Ireland Government Open Data

**URL:** [https://data.gov.ie/pages/developers](https://data.gov.ie/pages/developers)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.ie/pages/developers")
