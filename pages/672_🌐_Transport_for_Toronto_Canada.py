...
st.set_page_config(page_title="Transport for Toronto, Canada", page_icon="🌐")

st.title("🌐 Transport for Toronto, Canada")
st.markdown("""
TTC

**URL:** [https://myttc.ca/developers](https://myttc.ca/developers)
""")
...
url = st.text_input("API Endpoint", "https://myttc.ca/developers")
