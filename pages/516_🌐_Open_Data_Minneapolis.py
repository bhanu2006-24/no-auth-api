...
st.set_page_config(page_title="Open Data Minneapolis", page_icon="🌐")

st.title("🌐 Open Data Minneapolis")
st.markdown("""
Spatial (GIS) and non-spatial city data for Minneapolis

**URL:** [https://opendata.minneapolismn.gov/](https://opendata.minneapolismn.gov/)
""")
...
url = st.text_input("API Endpoint", "https://opendata.minneapolismn.gov/")
