...
st.set_page_config(page_title="Dune", page_icon="🌐")

st.title("🌐 Dune")
st.markdown("""
A simple API which provides you with book, character, movie and quotes JSON data

**URL:** [https://github.com/ywalia01/dune-api](https://github.com/ywalia01/dune-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/ywalia01/dune-api")
