...
st.set_page_config(page_title="Comic Vine", page_icon="🌐")

st.title("🌐 Comic Vine")
st.markdown("""
Comics

**URL:** [https://comicvine.gamespot.com/api/documentation](https://comicvine.gamespot.com/api/documentation)
""")
...
url = st.text_input("API Endpoint", "https://comicvine.gamespot.com/api/documentation")
