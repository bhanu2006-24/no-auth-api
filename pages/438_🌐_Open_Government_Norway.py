...
st.set_page_config(page_title="Open Government, Norway", page_icon="🌐")

st.title("🌐 Open Government, Norway")
st.markdown("""
Norwegian Government Open Data

**URL:** [https://data.norge.no/dataservices](https://data.norge.no/dataservices)
""")
...
url = st.text_input("API Endpoint", "https://data.norge.no/dataservices")
