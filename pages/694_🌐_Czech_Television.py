...
st.set_page_config(page_title="Czech Television", page_icon="🌐")

st.title("🌐 Czech Television")
st.markdown("""
TV programme of Czech TV

**URL:** [http://www.ceskatelevize.cz/xml/tv-program/](http://www.ceskatelevize.cz/xml/tv-program/)
""")
...
url = st.text_input("API Endpoint", "http://www.ceskatelevize.cz/xml/tv-program/")
