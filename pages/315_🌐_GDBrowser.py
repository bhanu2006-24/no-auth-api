...
st.set_page_config(page_title="GDBrowser", page_icon="🌐")

st.title("🌐 GDBrowser")
st.markdown("""
Easy way to use the Geometry Dash Servers

**URL:** [https://gdbrowser.com/api](https://gdbrowser.com/api)
""")
...
url = st.text_input("API Endpoint", "https://gdbrowser.com/api")
