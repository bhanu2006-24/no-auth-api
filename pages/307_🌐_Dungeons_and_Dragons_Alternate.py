...
st.set_page_config(page_title="Dungeons and Dragons (Alternate)", page_icon="🌐")

st.title("🌐 Dungeons and Dragons (Alternate)")
st.markdown("""
Includes all monsters and spells from the SRD (System Reference Document) as well as a search API

**URL:** [https://open5e.com/](https://open5e.com/)
""")
...
url = st.text_input("API Endpoint", "https://open5e.com/")
