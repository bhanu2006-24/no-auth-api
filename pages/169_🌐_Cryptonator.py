...
st.set_page_config(page_title="Cryptonator", page_icon="🌐")

st.title("🌐 Cryptonator")
st.markdown("""
Cryptocurrencies Exchange Rates

**URL:** [https://www.cryptonator.com/api/](https://www.cryptonator.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://www.cryptonator.com/api/")
