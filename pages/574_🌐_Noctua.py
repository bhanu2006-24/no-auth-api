...
st.set_page_config(page_title="Noctua", page_icon="🌐")

st.title("🌐 Noctua")
st.markdown("""
REST API used to access NoctuaSky features

**URL:** [https://api.noctuasky.com/api/v1/swaggerdoc/](https://api.noctuasky.com/api/v1/swaggerdoc/)
""")
...
url = st.text_input("API Endpoint", "https://api.noctuasky.com/api/v1/swaggerdoc/")
