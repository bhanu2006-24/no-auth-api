...
st.set_page_config(page_title="Stromberg Quotes", page_icon="🌐")

st.title("🌐 Stromberg Quotes")
st.markdown("""
Returns Stromberg quotes and more

**URL:** [https://www.stromberg-api.de/](https://www.stromberg-api.de/)
""")
...
url = st.text_input("API Endpoint", "https://www.stromberg-api.de/")
