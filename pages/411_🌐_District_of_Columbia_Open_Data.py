...
st.set_page_config(page_title="District of Columbia Open Data", page_icon="🌐")

st.title("🌐 District of Columbia Open Data")
st.markdown("""
Contains D.C. government public datasets, including crime, GIS, financial data, and so on

**URL:** [http://opendata.dc.gov/pages/using-apis](http://opendata.dc.gov/pages/using-apis)
""")
...
url = st.text_input("API Endpoint", "http://opendata.dc.gov/pages/using-apis")
