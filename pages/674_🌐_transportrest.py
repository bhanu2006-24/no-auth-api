...
st.set_page_config(page_title="transport.rest", page_icon="🌐")

st.title("🌐 transport.rest")
st.markdown("""
Community maintained, developer-friendly public transport API

**URL:** [https://transport.rest](https://transport.rest)
""")
...
url = st.text_input("API Endpoint", "https://transport.rest")
