...
st.set_page_config(page_title="Metabase", page_icon="🌐")

st.title("🌐 Metabase")
st.markdown("""
An open source Business Intelligence server to share data and analytics inside your company

**URL:** [https://www.metabase.com/](https://www.metabase.com/)
""")
...
url = st.text_input("API Endpoint", "https://www.metabase.com/")
