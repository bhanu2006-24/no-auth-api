...
st.set_page_config(page_title="Rwanda Locations", page_icon="🌐")

st.title("🌐 Rwanda Locations")
st.markdown("""
Rwanda Provences, Districts, Cities, Capital City, Sector, cells, villages and streets

**URL:** [https://rapidapi.com/victorkarangwa4/api/rwanda](https://rapidapi.com/victorkarangwa4/api/rwanda)
""")
...
url = st.text_input("API Endpoint", "https://rapidapi.com/victorkarangwa4/api/rwanda")
