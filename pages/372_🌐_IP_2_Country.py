...
st.set_page_config(page_title="IP 2 Country", page_icon="🌐")

st.title("🌐 IP 2 Country")
st.markdown("""
Map an IP to a country

**URL:** [https://ip2country.info](https://ip2country.info)
""")
...
url = st.text_input("API Endpoint", "https://ip2country.info")
