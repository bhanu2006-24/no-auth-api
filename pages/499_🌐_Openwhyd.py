...
st.set_page_config(page_title="Openwhyd", page_icon="🌐")

st.title("🌐 Openwhyd")
st.markdown("""
Download curated playlists of streaming tracks (YouTube, SoundCloud, etc...)

**URL:** [https://openwhyd.github.io/openwhyd/API](https://openwhyd.github.io/openwhyd/API)
""")
...
url = st.text_input("API Endpoint", "https://openwhyd.github.io/openwhyd/API")
