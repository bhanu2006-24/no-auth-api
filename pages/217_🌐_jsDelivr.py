...
**URL:** [https://github.com/jsdelivr/data.jsdelivr.com](https://github.com/jsdelivr/data.jsdelivr.com)
""")
...
url = st.text_input("API Endpoint", "https://github.com/jsdelivr/data.jsdelivr.com")
