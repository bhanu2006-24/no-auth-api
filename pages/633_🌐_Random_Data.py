...
st.set_page_config(page_title="Random Data", page_icon="🌐")

st.title("🌐 Random Data")
st.markdown("""
Random data generator

**URL:** [https://random-data-api.com](https://random-data-api.com)
""")
...
url = st.text_input("API Endpoint", "https://random-data-api.com")
