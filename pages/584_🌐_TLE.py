...
st.set_page_config(page_title="TLE", page_icon="🌐")

st.title("🌐 TLE")
st.markdown("""
Satellite information

**URL:** [https://tle.ivanstanojevic.me/#/docs](https://tle.ivanstanojevic.me/#/docs)
""")
...
url = st.text_input("API Endpoint", "https://tle.ivanstanojevic.me/#/docs")
