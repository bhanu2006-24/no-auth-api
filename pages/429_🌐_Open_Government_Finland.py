...
st.set_page_config(page_title="Open Government, Finland", page_icon="🌐")

st.title("🌐 Open Government, Finland")
st.markdown("""
Finland Government Open Data

**URL:** [https://www.avoindata.fi/en](https://www.avoindata.fi/en)
""")
...
url = st.text_input("API Endpoint", "https://www.avoindata.fi/en")
