...
st.set_page_config(page_title="MercadoBitcoin", page_icon="🌐")

st.title("🌐 MercadoBitcoin")
st.markdown("""
Brazilian Cryptocurrency Information

**URL:** [https://www.mercadobitcoin.com.br/api-doc/](https://www.mercadobitcoin.com.br/api-doc/)
""")
...
url = st.text_input("API Endpoint", "https://www.mercadobitcoin.com.br/api-doc/")
