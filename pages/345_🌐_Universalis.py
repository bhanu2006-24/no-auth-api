...
st.set_page_config(page_title="Universalis", page_icon="🌐")

st.title("🌐 Universalis")
st.markdown("""
Final Fantasy XIV market board data

**URL:** [https://universalis.app/docs/index.html](https://universalis.app/docs/index.html)
""")
...
url = st.text_input("API Endpoint", "https://universalis.app/docs/index.html")
