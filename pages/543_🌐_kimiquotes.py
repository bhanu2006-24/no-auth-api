...
st.set_page_config(page_title="kimiquotes", page_icon="🌐")

st.title("🌐 kimiquotes")
st.markdown("""
Team radio and interview quotes by Finnish F1 legend Kimi Räikkönen

**URL:** [https://kimiquotes.herokuapp.com/doc](https://kimiquotes.herokuapp.com/doc)
""")
...
url = st.text_input("API Endpoint", "https://kimiquotes.herokuapp.com/doc")
