...
st.set_page_config(page_title="Steam", page_icon="🌐")

st.title("🌐 Steam")
st.markdown("""
Internal Steam Web API documentation

**URL:** [https://github.com/Revadike/InternalSteamWebAPI/wiki](https://github.com/Revadike/InternalSteamWebAPI/wiki)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Revadike/InternalSteamWebAPI/wiki")
