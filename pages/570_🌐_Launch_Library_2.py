...
st.set_page_config(page_title="Launch Library 2", page_icon="🌐")

st.title("🌐 Launch Library 2")
st.markdown("""
Spaceflight launches and events database

**URL:** [https://thespacedevs.com/llapi](https://thespacedevs.com/llapi)
""")
...
url = st.text_input("API Endpoint", "https://thespacedevs.com/llapi")
