...
st.set_page_config(page_title="Random Useless Facts", page_icon="🌐")

st.title("🌐 Random Useless Facts")
st.markdown("""
Get useless, but true facts

**URL:** [https://uselessfacts.jsph.pl/](https://uselessfacts.jsph.pl/)
""")
...
url = st.text_input("API Endpoint", "https://uselessfacts.jsph.pl/")
