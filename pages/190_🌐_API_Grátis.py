...
st.set_page_config(page_title="API Grátis", page_icon="🌐")

st.title("🌐 API Grátis")
st.markdown("""
Multiples services and public APIs

**URL:** [https://apigratis.com.br/](https://apigratis.com.br/)
""")
...
url = st.text_input("API Endpoint", "https://apigratis.com.br/")
