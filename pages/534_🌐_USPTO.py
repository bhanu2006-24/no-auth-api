...
st.set_page_config(page_title="USPTO", page_icon="🌐")

st.title("🌐 USPTO")
st.markdown("""
USA patent api services

**URL:** [https://www.uspto.gov/learning-and-resources/open-data-and-mobility](https://www.uspto.gov/learning-and-resources/open-data-and-mobility)
""")
...
url = st.text_input("API Endpoint", "https://www.uspto.gov/learning-and-resources/open-data-and-mobility")
