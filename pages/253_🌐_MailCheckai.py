...
st.set_page_config(page_title="MailCheck.ai", page_icon="🌐")

st.title("🌐 MailCheck.ai")
st.markdown("""
Prevent users to sign up with temporary email addresses

**URL:** [https://www.mailcheck.ai/#documentation](https://www.mailcheck.ai/#documentation)
""")
...
url = st.text_input("API Endpoint", "https://www.mailcheck.ai/#documentation")
