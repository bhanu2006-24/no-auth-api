...
st.set_page_config(page_title="Colorado Information Marketplace", page_icon="🌐")

st.title("🌐 Colorado Information Marketplace")
st.markdown("""
Colorado State Government Open Data

**URL:** [https://data.colorado.gov/](https://data.colorado.gov/)
""")
...
url = st.text_input("API Endpoint", "https://data.colorado.gov/")
