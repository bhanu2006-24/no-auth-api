...
st.set_page_config(page_title="TCGdex", page_icon="🌐")

st.title("🌐 TCGdex")
st.markdown("""
Multi languages Pokémon TCG Information

**URL:** [https://www.tcgdex.net/docs](https://www.tcgdex.net/docs)
""")
...
url = st.text_input("API Endpoint", "https://www.tcgdex.net/docs")
