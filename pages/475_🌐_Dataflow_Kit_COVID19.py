...
st.set_page_config(page_title="Dataflow Kit COVID-19", page_icon="🌐")

st.title("🌐 Dataflow Kit COVID-19")
st.markdown("""
COVID-19 live statistics into sites per hour

**URL:** [https://covid-19.dataflowkit.com](https://covid-19.dataflowkit.com)
""")
...
url = st.text_input("API Endpoint", "https://covid-19.dataflowkit.com")
