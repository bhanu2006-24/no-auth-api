...
st.title("🌐 Open Trivia")
st.markdown("""
Trivia Questions

**URL:** [https://opentdb.com/api_config.php](https://opentdb.com/api_config.php)
""")
...
url = st.text_input("API Endpoint", "https://opentdb.com/api_config.php")
