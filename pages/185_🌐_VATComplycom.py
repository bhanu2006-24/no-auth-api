...
st.set_page_config(page_title="VATComply.com", page_icon="🌐")

st.title("🌐 VATComply.com")
st.markdown("""
Exchange rates, geolocation and VAT number validation

**URL:** [https://www.vatcomply.com/documentation](https://www.vatcomply.com/documentation)
""")
...
url = st.text_input("API Endpoint", "https://www.vatcomply.com/documentation")
