...
st.set_page_config(page_title="Econdb", page_icon="🌐")

st.title("🌐 Econdb")
st.markdown("""
Global macroeconomic data

**URL:** [https://www.econdb.com/api/](https://www.econdb.com/api/)
""")
...
url = st.text_input("API Endpoint", "https://www.econdb.com/api/")
