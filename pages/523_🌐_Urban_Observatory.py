...
st.set_page_config(page_title="Urban Observatory", page_icon="🌐")

st.title("🌐 Urban Observatory")
st.markdown("""
The largest set of publicly available real time urban data in the UK

**URL:** [https://urbanobservatory.ac.uk](https://urbanobservatory.ac.uk)
""")
...
url = st.text_input("API Endpoint", "https://urbanobservatory.ac.uk")
