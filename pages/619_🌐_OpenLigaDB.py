...
st.set_page_config(page_title="OpenLigaDB", page_icon="🌐")

st.title("🌐 OpenLigaDB")
st.markdown("""
Crowd sourced sports league results

**URL:** [https://www.openligadb.de](https://www.openligadb.de)
""")
...
url = st.text_input("API Endpoint", "https://www.openligadb.de")
