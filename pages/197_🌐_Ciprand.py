...
st.set_page_config(page_title="Ciprand", page_icon="🌐")

st.title("🌐 Ciprand")
st.markdown("""
Secure random string generator

**URL:** [https://github.com/polarspetroll/ciprand](https://github.com/polarspetroll/ciprand)
""")
...
url = st.text_input("API Endpoint", "https://github.com/polarspetroll/ciprand")
