...
st.set_page_config(page_title="JioSaavn", page_icon="🌐")

st.title("🌐 JioSaavn")
st.markdown("""
API to retrieve song information, album meta data and many more from JioSaavn

**URL:** [https://github.com/cyberboysumanjay/JioSaavnAPI](https://github.com/cyberboysumanjay/JioSaavnAPI)
""")
...
url = st.text_input("API Endpoint", "https://github.com/cyberboysumanjay/JioSaavnAPI")
