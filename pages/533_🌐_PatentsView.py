...
st.set_page_config(page_title="PatentsView", page_icon="🌐")

st.title("🌐 PatentsView")
st.markdown("""
API is intended to explore and visualize trends/patterns across the US innovation landscape

**URL:** [https://patentsview.org/apis/purpose](https://patentsview.org/apis/purpose)
""")
...
url = st.text_input("API Endpoint", "https://patentsview.org/apis/purpose")
