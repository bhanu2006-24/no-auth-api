...
st.set_page_config(page_title="Transport for Berlin, Germany", page_icon="🌐")

st.title("🌐 Transport for Berlin, Germany")
st.markdown("""
Third-party VBB API

**URL:** [https://github.com/derhuerst/vbb-rest/blob/3/docs/index.md](https://github.com/derhuerst/vbb-rest/blob/3/docs/index.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/derhuerst/vbb-rest/blob/3/docs/index.md")
