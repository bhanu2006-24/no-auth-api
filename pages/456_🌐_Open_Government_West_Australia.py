...
st.set_page_config(page_title="Open Government, West Australia", page_icon="🌐")

st.title("🌐 Open Government, West Australia")
st.markdown("""
West Australia Open Data

**URL:** [https://data.wa.gov.au/](https://data.wa.gov.au/)
""")
...
url = st.text_input("API Endpoint", "https://data.wa.gov.au/")
