...
st.set_page_config(page_title="Transport for Spain", page_icon="🌐")

st.title("🌐 Transport for Spain")
st.markdown("""
Public trains of Spain

**URL:** [https://data.renfe.com/api/1/util/snippet/api_info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a](https://data.renfe.com/api/1/util/snippet/api_info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a)
""")
...
url = st.text_input("API Endpoint", "https://data.renfe.com/api/1/util/snippet/api_info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a")
