...
st.set_page_config(page_title="GoTiny", page_icon="🌐")

st.title("🌐 GoTiny")
st.markdown("""
A lightweight URL shortener, focused on ease-of-use for the developer and end-user

**URL:** [https://github.com/robvanbakel/gotiny-api](https://github.com/robvanbakel/gotiny-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/robvanbakel/gotiny-api")
