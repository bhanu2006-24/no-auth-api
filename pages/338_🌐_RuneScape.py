...
st.set_page_config(page_title="RuneScape", page_icon="🌐")

st.title("🌐 RuneScape")
st.markdown("""
RuneScape and OSRS RPGs information

**URL:** [https://runescape.wiki/w/Application_programming_interface](https://runescape.wiki/w/Application_programming_interface)
""")
...
url = st.text_input("API Endpoint", "https://runescape.wiki/w/Application_programming_interface")
