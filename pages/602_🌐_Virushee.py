...
st.set_page_config(page_title="Virushee", page_icon="🌐")

st.title("🌐 Virushee")
st.markdown("""
Virushee file/data scanning

**URL:** [https://api.virushee.com/](https://api.virushee.com/)
""")
...
url = st.text_input("API Endpoint", "https://api.virushee.com/")
