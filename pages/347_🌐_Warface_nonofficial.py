...
st.set_page_config(page_title="Warface (non-official)", page_icon="🌐")

st.title("🌐 Warface (non-official)")
st.markdown("""
Official API proxy with better data structure and more features

**URL:** [https://api.wfstats.cf](https://api.wfstats.cf)
""")
...
url = st.text_input("API Endpoint", "https://api.wfstats.cf")
