...
st.set_page_config(page_title="GeographQL", page_icon="🌐")

st.title("🌐 GeographQL")
st.markdown("""
A Country, State, and City GraphQL API

**URL:** [https://geographql.netlify.app](https://geographql.netlify.app)
""")
...
url = st.text_input("API Endpoint", "https://geographql.netlify.app")
