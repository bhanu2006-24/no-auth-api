...
st.set_page_config(page_title="PM2.5 Open Data Portal", page_icon="🌐")

st.title("🌐 PM2.5 Open Data Portal")
st.markdown("""
Open low-cost PM2.5 sensor data

**URL:** [https://pm25.lass-net.org/#apis](https://pm25.lass-net.org/#apis)
""")
...
url = st.text_input("API Endpoint", "https://pm25.lass-net.org/#apis")
