...
st.title("🌐 Fed Treasury")
st.markdown("""
U.S. Department of the Treasury Data

**URL:** [https://fiscaldata.treasury.gov/api-documentation/](https://fiscaldata.treasury.gov/api-documentation/)
""")
...
url = st.text_input("API Endpoint", "https://fiscaldata.treasury.gov/api-documentation/")
