...
st.set_page_config(page_title="Transport for Budapest, Hungary", page_icon="🌐")

st.title("🌐 Transport for Budapest, Hungary")
st.markdown("""
Budapest public transport API

**URL:** [https://bkkfutar.docs.apiary.io](https://bkkfutar.docs.apiary.io)
""")
...
url = st.text_input("API Endpoint", "https://bkkfutar.docs.apiary.io")
