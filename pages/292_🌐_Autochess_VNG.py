...
st.set_page_config(page_title="Autochess VNG", page_icon="🌐")

st.title("🌐 Autochess VNG")
st.markdown("""
Rest Api for Autochess VNG

**URL:** [https://github.com/didadadida93/autochess-vng-api](https://github.com/didadadida93/autochess-vng-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/didadadida93/autochess-vng-api")
