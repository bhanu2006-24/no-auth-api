...
st.set_page_config(page_title="Metaphorsum", page_icon="🌐")

st.title("🌐 Metaphorsum")
st.markdown("""
Generate demo paragraphs giving number of words and sentences

**URL:** [http://metaphorpsum.com/](http://metaphorpsum.com/)
""")
...
url = st.text_input("API Endpoint", "http://metaphorpsum.com/")
