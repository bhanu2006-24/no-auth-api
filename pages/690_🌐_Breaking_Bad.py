...
st.set_page_config(page_title="Breaking Bad", page_icon="🌐")

st.title("🌐 Breaking Bad")
st.markdown("""
Breaking Bad API

**URL:** [https://breakingbadapi.com/documentation](https://breakingbadapi.com/documentation)
""")
...
url = st.text_input("API Endpoint", "https://breakingbadapi.com/documentation")
