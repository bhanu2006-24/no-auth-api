...
st.title("🌐 BitcoinCharts")
st.markdown("""
Financial and Technical Data related to the Bitcoin Network

**URL:** [https://bitcoincharts.com/about/exchanges/](https://bitcoincharts.com/about/exchanges/)
""")
...
url = st.text_input("API Endpoint", "https://bitcoincharts.com/about/exchanges/")
