...
st.set_page_config(page_title="Open Government, Victoria State Government", page_icon="🌐")

st.title("🌐 Open Government, Victoria State Government")
st.markdown("""
Victoria State Government Open Data

**URL:** [https://www.data.vic.gov.au/](https://www.data.vic.gov.au/)
""")
...
url = st.text_input("API Endpoint", "https://www.data.vic.gov.au/")
