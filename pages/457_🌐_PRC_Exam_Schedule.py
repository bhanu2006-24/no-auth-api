...
st.set_page_config(page_title="PRC Exam Schedule", page_icon="🌐")

st.title("🌐 PRC Exam Schedule")
st.markdown("""
Unofficial Philippine Professional Regulation Commission's examination schedule

**URL:** [https://api.whenisthenextboardexam.com/docs/](https://api.whenisthenextboardexam.com/docs/)
""")
...
url = st.text_input("API Endpoint", "https://api.whenisthenextboardexam.com/docs/")
