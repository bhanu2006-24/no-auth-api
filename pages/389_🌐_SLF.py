...
st.set_page_config(page_title="SLF", page_icon="🌐")

st.title("🌐 SLF")
st.markdown("""
German city, country, river, database

**URL:** [https://github.com/slftool/slftool.github.io/blob/master/API.md](https://github.com/slftool/slftool.github.io/blob/master/API.md)
""")
...
url = st.text_input("API Endpoint", "https://github.com/slftool/slftool.github.io/blob/master/API.md")
