...
st.set_page_config(page_title="Covid-19 JHU CSSE", page_icon="🌐")

st.title("🌐 Covid-19 JHU CSSE")
st.markdown("""
Open-source API for exploring Covid19 cases based on JHU CSSE

**URL:** [https://nuttaphat.com/covid19-api/](https://nuttaphat.com/covid19-api/)
""")
...
url = st.text_input("API Endpoint", "https://nuttaphat.com/covid19-api/")
