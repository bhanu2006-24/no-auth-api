...
st.set_page_config(page_title="Sunrise and Sunset", page_icon="🌐")

st.title("🌐 Sunrise and Sunset")
st.markdown("""
Sunset and sunrise times for a given latitude and longitude

**URL:** [https://sunrise-sunset.org/api](https://sunrise-sunset.org/api)
""")
...
url = st.text_input("API Endpoint", "https://sunrise-sunset.org/api")
