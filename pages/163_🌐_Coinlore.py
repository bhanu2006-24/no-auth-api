...
**URL:** [https://www.coinlore.com/cryptocurrency-data-api](https://www.coinlore.com/cryptocurrency-data-api)
""")
...
url = st.text_input("API Endpoint", "https://www.coinlore.com/cryptocurrency-data-api")
