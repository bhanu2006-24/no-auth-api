...
st.set_page_config(page_title="Mocky", page_icon="🌐")

st.title("🌐 Mocky")
st.markdown("""
Mock user defined test JSON for REST API endpoints

**URL:** [https://designer.mocky.io/](https://designer.mocky.io/)
""")
...
url = st.text_input("API Endpoint", "https://designer.mocky.io/")
