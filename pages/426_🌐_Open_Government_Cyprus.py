...
st.set_page_config(page_title="Open Government, Cyprus", page_icon="🌐")

st.title("🌐 Open Government, Cyprus")
st.markdown("""
Cyprus Government Open Data

**URL:** [https://data.gov.cy/?language=en](https://data.gov.cy/?language=en)
""")
...
url = st.text_input("API Endpoint", "https://data.gov.cy/?language=en")
