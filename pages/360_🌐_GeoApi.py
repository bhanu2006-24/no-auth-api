...
st.set_page_config(page_title="GeoApi", page_icon="🌐")

st.title("🌐 GeoApi")
st.markdown("""
French geographical data

**URL:** [https://api.gouv.fr/api/geoapi.html](https://api.gouv.fr/api/geoapi.html)
""")
...
url = st.text_input("API Endpoint", "https://api.gouv.fr/api/geoapi.html")
