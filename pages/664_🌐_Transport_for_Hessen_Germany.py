...
st.set_page_config(page_title="Transport for Hessen, Germany", page_icon="🌐")

st.title("🌐 Transport for Hessen, Germany")
st.markdown("""
RMV API (Public Transport in Hessen)

**URL:** [https://opendata.rmv.de/site/start.html](https://opendata.rmv.de/site/start.html)
""")
...
url = st.text_input("API Endpoint", "https://opendata.rmv.de/site/start.html")
