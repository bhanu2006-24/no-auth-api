...
st.set_page_config(page_title="CollegeScoreCard.ed.gov", page_icon="🌐")

st.title("🌐 CollegeScoreCard.ed.gov")
st.markdown("""
...
url = st.text_input("API Endpoint", "https://collegescorecard.ed.gov/data/")
