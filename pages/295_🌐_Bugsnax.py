...
st.set_page_config(page_title="Bugsnax", page_icon="🌐")

st.title("🌐 Bugsnax")
st.markdown("""
Get information about Bugsnax

**URL:** [https://www.bugsnaxapi.com/](https://www.bugsnaxapi.com/)
""")
...
url = st.text_input("API Endpoint", "https://www.bugsnaxapi.com/")
