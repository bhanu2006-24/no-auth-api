...
st.set_page_config(page_title="Represent by Open North", page_icon="🌐")

st.title("🌐 Represent by Open North")
st.markdown("""
Find Canadian Government Representatives

**URL:** [https://represent.opennorth.ca/](https://represent.opennorth.ca/)
""")
...
url = st.text_input("API Endpoint", "https://represent.opennorth.ca/")
