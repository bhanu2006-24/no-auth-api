...
st.set_page_config(page_title="Open Collective", page_icon="🌐")

st.title("🌐 Open Collective")
st.markdown("""
Get Open Collective data

**URL:** [https://docs.opencollective.com/help/developers/api](https://docs.opencollective.com/help/developers/api)
""")
...
url = st.text_input("API Endpoint", "https://docs.opencollective.com/help/developers/api")
