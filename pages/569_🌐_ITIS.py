...
st.set_page_config(page_title="ITIS", page_icon="🌐")

st.title("🌐 ITIS")
st.markdown("""
Integrated Taxonomic Information System

**URL:** [https://www.itis.gov/ws_description.html](https://www.itis.gov/ws_description.html)
""")
...
url = st.text_input("API Endpoint", "https://www.itis.gov/ws_description.html")
