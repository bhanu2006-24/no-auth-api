...
st.set_page_config(page_title="7Timer!", page_icon="🌐")

st.title("🌐 7Timer!")
st.markdown("""
Weather, especially for Astroweather

**URL:** [http://www.7timer.info/doc.php?lang=en](http://www.7timer.info/doc.php?lang=en)
""")
...
url = st.text_input("API Endpoint", "http://www.7timer.info/doc.php?lang=en")
