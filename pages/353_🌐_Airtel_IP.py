...
st.set_page_config(page_title="Airtel IP", page_icon="🌐")

st.title("🌐 Airtel IP")
st.markdown("""
IP Geolocation API. Collecting data from multiple sources

**URL:** [https://sys.airtel.lv/ip2country/1.1.1.1/?full=true](https://sys.airtel.lv/ip2country/1.1.1.1/?full=true)
""")
...
url = st.text_input("API Endpoint", "https://sys.airtel.lv/ip2country/1.1.1.1/?full=true")
