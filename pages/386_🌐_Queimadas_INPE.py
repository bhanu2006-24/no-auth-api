...
st.set_page_config(page_title="Queimadas INPE", page_icon="🌐")

st.title("🌐 Queimadas INPE")
st.markdown("""
Access to heat focus data (probable wildfire)

**URL:** [https://queimadas.dgi.inpe.br/queimadas/dados-abertos/](https://queimadas.dgi.inpe.br/queimadas/dados-abertos/)
""")
...
url = st.text_input("API Endpoint", "https://queimadas.dgi.inpe.br/queimadas/dados-abertos/")
