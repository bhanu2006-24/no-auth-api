...
st.set_page_config(page_title="Sport List & Data", page_icon="🌐")

st.title("🌐 Sport List & Data")
st.markdown("""
List of and resources related to sports

**URL:** [https://developers.decathlon.com/products/sports](https://developers.decathlon.com/products/sports)
""")
...
url = st.text_input("API Endpoint", "https://developers.decathlon.com/products/sports")
