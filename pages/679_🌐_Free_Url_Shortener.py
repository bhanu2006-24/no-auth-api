...
st.set_page_config(page_title="Free Url Shortener", page_icon="🌐")

st.title("🌐 Free Url Shortener")
st.markdown("""
Free URL Shortener offers a powerful API to interact with other sites

**URL:** [https://ulvis.net/developer.html](https://ulvis.net/developer.html)
""")
...
url = st.text_input("API Endpoint", "https://ulvis.net/developer.html")
