...
st.set_page_config(page_title="Mgnet.me", page_icon="🌐")

st.title("🌐 Mgnet.me")
st.markdown("""
Torrent URL shorten API

**URL:** [http://mgnet.me/api.html](http://mgnet.me/api.html)
""")
...
url = st.text_input("API Endpoint", "http://mgnet.me/api.html")
