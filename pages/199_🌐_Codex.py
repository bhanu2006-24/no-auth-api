...
st.set_page_config(page_title="Codex", page_icon="🌐")

st.title("🌐 Codex")
st.markdown("""
Online Compiler for Various Languages

**URL:** [https://github.com/Jaagrav/CodeX](https://github.com/Jaagrav/CodeX)
""")
...
url = st.text_input("API Endpoint", "https://github.com/Jaagrav/CodeX")
