...
st.set_page_config(page_title="EXUDE-API", page_icon="🌐")

st.title("🌐 EXUDE-API")
st.markdown("""
Used for the primary ways for filtering the stopping, stemming words from the text data

**URL:** [http://uttesh.com/exude-api/](http://uttesh.com/exude-api/)
""")
...
url = st.text_input("API Endpoint", "http://uttesh.com/exude-api/")
