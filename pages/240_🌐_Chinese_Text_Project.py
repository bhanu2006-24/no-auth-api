...
st.set_page_config(page_title="Chinese Text Project", page_icon="🌐")

st.title("🌐 Chinese Text Project")
st.markdown("""
Online open-access digital library for pre-modern Chinese texts

**URL:** [https://ctext.org/tools/api](https://ctext.org/tools/api)
""")
...
url = st.text_input("API Endpoint", "https://ctext.org/tools/api")
