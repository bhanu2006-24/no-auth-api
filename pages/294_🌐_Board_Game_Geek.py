...
st.set_page_config(page_title="Board Game Geek", page_icon="🌐")

st.title("🌐 Board Game Geek")
st.markdown("""
Board games, RPG and videogames

**URL:** [https://boardgamegeek.com/wiki/page/BGG_XML_API2](https://boardgamegeek.com/wiki/page/BGG_XML_API2)
""")
...
url = st.text_input("API Endpoint", "https://boardgamegeek.com/wiki/page/BGG_XML_API2")
