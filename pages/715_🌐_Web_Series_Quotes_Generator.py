...
st.set_page_config(page_title="Web Series Quotes Generator", page_icon="🌐")

st.title("🌐 Web Series Quotes Generator")
st.markdown("""
API generates various Web Series Quote Images

**URL:** [https://github.com/yogeshwaran01/web-series-quotes](https://github.com/yogeshwaran01/web-series-quotes)
""")
...
url = st.text_input("API Endpoint", "https://github.com/yogeshwaran01/web-series-quotes")
