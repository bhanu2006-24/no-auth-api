...
st.set_page_config(page_title="What The Commit", page_icon="🌐")

st.title("🌐 What The Commit")
st.markdown("""
Random commit message generator

**URL:** [http://whatthecommit.com/index.txt](http://whatthecommit.com/index.txt)
""")
...
url = st.text_input("API Endpoint", "http://whatthecommit.com/index.txt")
