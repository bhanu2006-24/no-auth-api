...
st.set_page_config(page_title="Forza", page_icon="🌐")

st.title("🌐 Forza")
st.markdown("""
Show random image of car from Forza

**URL:** [https://docs.forza-api.tk](https://docs.forza-api.tk)
""")
...
url = st.text_input("API Endpoint", "https://docs.forza-api.tk")
