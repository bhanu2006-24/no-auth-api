...
st.set_page_config(page_title="Inshorts News", page_icon="🌐")

st.title("🌐 Inshorts News")
st.markdown("""
Provides news from inshorts

**URL:** [https://github.com/cyberboysumanjay/Inshorts-News-API](https://github.com/cyberboysumanjay/Inshorts-News-API)
""")
...
url = st.text_input("API Endpoint", "https://github.com/cyberboysumanjay/Inshorts-News-API")
