...
st.set_page_config(page_title="Namedays Calendar", page_icon="🌐")

st.title("🌐 Namedays Calendar")
st.markdown("""
Provides namedays for multiple countries

**URL:** [https://nameday.abalin.net](https://nameday.abalin.net)
""")
...
url = st.text_input("API Endpoint", "https://nameday.abalin.net")
