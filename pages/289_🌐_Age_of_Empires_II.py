...
st.set_page_config(page_title="Age of Empires II", page_icon="🌐")

st.title("🌐 Age of Empires II")
st.markdown("""
Get information about Age of Empires II resources

**URL:** [https://age-of-empires-2-api.herokuapp.com](https://age-of-empires-2-api.herokuapp.com)
""")
...
url = st.text_input("API Endpoint", "https://age-of-empires-2-api.herokuapp.com")
