...
st.set_page_config(page_title="Metro Lisboa", page_icon="🌐")

st.title("🌐 Metro Lisboa")
st.markdown("""
Delays in subway lines

**URL:** [http://app.metrolisboa.pt/status/getLinhas.php](http://app.metrolisboa.pt/status/getLinhas.php)
""")
...
url = st.text_input("API Endpoint", "http://app.metrolisboa.pt/status/getLinhas.php")
