...
st.set_page_config(page_title="inspirehep.net", page_icon="🌐")

st.title("🌐 inspirehep.net")
st.markdown("""
High Energy Physics info. system

**URL:** [https://github.com/inspirehep/rest-api-doc](https://github.com/inspirehep/rest-api-doc)
""")
...
url = st.text_input("API Endpoint", "https://github.com/inspirehep/rest-api-doc")
