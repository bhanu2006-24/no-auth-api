...
st.set_page_config(page_title="Ron Swanson Quotes", page_icon="🌐")

st.title("🌐 Ron Swanson Quotes")
st.markdown("""
Television

**URL:** [https://github.com/jamesseanwright/ron-swanson-quotes#ron-swanson-quotes-api](https://github.com/jamesseanwright/ron-swanson-quotes#ron-swanson-quotes-api)
""")
...
url = st.text_input("API Endpoint", "https://github.com/jamesseanwright/ron-swanson-quotes#ron-swanson-quotes-api")
