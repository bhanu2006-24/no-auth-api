# No Auth API Showcase 🚀

A Streamlit application demonstrating **725** public APIs that require no authentication.

## Features
- **725 API Demos**: Interactive pages for each API.
- **No Keys Required**: All APIs are free and public.
- **Python & Streamlit**: Built with pure Python.

## Installation

1. Clone the repository:
   ```bash
   git clone https://github.com/bhanupratapsaini/no-auth-api.git
   cd no-auth-api
   ```
